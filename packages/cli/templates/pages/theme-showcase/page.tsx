...
// Styles passed to Khameleon components via their `style` prop. Khameleon components
...
// Neutral product photos, served from the shared khameleon asset CDN so the
// scaffolded template renders real imagery without needing local public assets.
const DEFAULT_IMAGES: Record<string, string> = {
  watch: 'https://lookaside.facebook.com/assets/khameleon/Neutral-Watch.png',
  headphones:
    'https://lookaside.facebook.com/assets/khameleon/Neutral-Headphones.png',
  backpack: 'https://lookaside.facebook.com/assets/khameleon/Neutral-Backpack.png',
  wallet: 'https://lookaside.facebook.com/assets/khameleon/Neutral-Wallet.png',
  tumbler: 'https://lookaside.facebook.com/assets/khameleon/Neutral-Tumbler.png',
  throw_: 'https://lookaside.facebook.com/assets/khameleon/Neutral-Blanket.png',
};
