...
import {TopNav} from '@khameleon/core/TopNav';
...
import {SideNav} from '@khameleon/core/SideNav';
...
import {Stack, VStack, HStack} from '@khameleon/core/Stack';
import {
  PlayIcon,
  MagnifyingGlassIcon,
  FolderIcon,
  ...
  return (
    <>
      <AppShell
        ...
        topNav={
          <TopNav
            label="Khameleon Studio menu bar"
            startContent={
              <>
                {MENUS.map(menu => (
                  <DropdownMenu
