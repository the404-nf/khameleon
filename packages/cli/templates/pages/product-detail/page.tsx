...
import {VStack, HStack, Layout, LayoutContent} from '@khameleon/core/Layout';
...
// Custom CSS here is limited to what Khameleon components can't express today:
// - image fill + corner radius (no Image primitive — #2582)
// - the sticky info column (no sticky prop on Khameleon layout primitives — #2613)
// Keeps the info column in view while the gallery scrolls. No sticky prop on
// Khameleon layout primitives.
...
const IMAGES = [
  'https://lookaside.facebook.com/assets/khameleon/light-product-1.png',
  'https://lookaside.facebook.com/assets/khameleon/light-product-1.png',
  'https://lookaside.facebook.com/assets/khameleon/light-product-2.png',
  'https://lookaside.facebook.com/assets/khameleon/light-product-3.png',
  'https://lookaside.facebook.com/assets/khameleon/light-product-4.png',
  'https://lookaside.facebook.com/assets/khameleon/light-product-5.png',
  'https://lookaside.facebook.com/assets/khameleon/light-product-3.png',
];
