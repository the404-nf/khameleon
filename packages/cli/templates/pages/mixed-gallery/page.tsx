...
// @container grid (the sanctioned Khameleon pattern for container-responsive layout).
// The container query lives in a plain <style> tag below so it needs NO CSS
// compiler. Image fill + radius are custom because Khameleon has no image
// primitive (#2582).
...
const IMAGES: GalleryImage[] = [
  ...
  {
    src: 'https://lookaside.facebook.com/assets/khameleon/light-home-horizontal-1.png',
    title: 'Making memories',
  },
  {
    src: 'https://lookaside.facebook.com/assets/khameleon/light-lifestyle-horizontal-1.png',
    title: 'Being free',
  },
  {
    src: 'https://lookaside.facebook.com/assets/khameleon/light-working-horizontal-2.png',
