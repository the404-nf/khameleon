          ...
          <VStack gap={8}>
            ...
            <Card>
              <VStack gap={3}>
                  ...
                  <Button
                    ...
                    onClick={() => {
                      void navigator.clipboard.writeText(
                        'Help me get set up with Product Name. Based on my project, do the following: 1. Install @khameleon/core and the StyleX compiler. 2. Wrap my app in ThemeProvider. 3. Replace one existing component with an Khameleon equivalent. After setup, suggest relevant next steps based on my project.',
                      );
                    }}
                  />
                  <DropdownMenu
                ...
                <Text type="body" color="secondary">
                  ...
                  the following: 1. Install @khameleon/core and the StyleX
                  compiler. 2. Wrap my app in ThemeProvider. 3. Replace one
                  existing component with an Khameleon equivalent.
                </Text>
              </VStack>
            </Card>
            ...
            <VStack gap={4}>
              ...
              <VStack gap={2}>
                ...
                <Text type="body" color="secondary">
                  Khameleon ships precompiled CSS, so there is no build plugin to
...
export default function App() {
  return <Button label="Hello Khameleon" variant="primary" />;
            ...
            <VStack gap={4}>
              ...
              <Text type="body">
                Khameleon ships with a default theme that works out of the box. To
                customize colors, typography, and spacing, wrap your app in a
                theme provider.
              </Text>
              <CodeBlock
                code={`import { ThemeProvider } from '@khameleon/core/Theme';
