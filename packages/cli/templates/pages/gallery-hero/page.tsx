...
const IMAGES = [
  {
    src: 'https://lookaside.facebook.com/assets/khameleon/colorful-home-horizontal-1.png',
...
// because Khameleon has no image primitive — AspectRatio exposes no objectFit or
