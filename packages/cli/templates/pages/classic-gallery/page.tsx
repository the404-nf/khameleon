...
const GALLERY_IMAGES: GalleryImage[] = [
  {
    src: 'https://lookaside.facebook.com/assets/khameleon/moody-scene-horizontal-1.png',
    alt: 'Moody scene landscape',
    category: 'scene',
  },
  {
    src: 'https://lookaside.facebook.com/assets/khameleon/moody-lifestyle-vertical-1.png',
    alt: 'Moody lifestyle portrait',
    category: 'lifestyle',
  },
  {
    src: 'https://lookaside.facebook.com/assets/khameleon/moody-home-vertical-1.png',
    alt: 'Moody home interior',
    category: 'home',
  },
  {
    src: 'https://lookaside.facebook.com/assets/khameleon/moody-scene-horizontal-2.png',
    alt: 'Moody scene vista',
    category: 'scene',
  },
  {
    src: 'https://lookaside.facebook.com/assets/khameleon/moody-lifestyle-vertical-2.png',
    alt: 'Moody lifestyle scene',
    category: 'lifestyle',
  },
  {
    src: 'https://lookaside.facebook.com/assets/khameleon/moody-lifestyle-horizontal-1.png',
    alt: 'Moody lifestyle horizontal',
    category: 'lifestyle',
  },
  {
    src: 'https://lookaside.facebook.com/assets/khameleon/moody-scene-vertical-1.png',
    alt: 'Moody scene vertical',
    category: 'scene',
  },
  {
    src: 'https://lookaside.facebook.com/assets/khameleon/moody-home-vertical-2.png',
    alt: 'Moody home vertical',
    category: 'home',
  },
  {
    src: 'https://lookaside.facebook.com/assets/khameleon/moody-home-horizontal-1.png',
    alt: 'Moody home horizontal',
    category: 'home',
  },
  {
    src: 'https://lookaside.facebook.com/assets/khameleon/moody-scene-vertical-2.png',
    alt: 'Moody scene vertical',
    category: 'scene',
  },
];
