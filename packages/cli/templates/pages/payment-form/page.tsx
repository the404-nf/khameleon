...
const ITEM_IMAGES: Record<string, {src: string}> = {
  '1': {src: 'https://lookaside.facebook.com/assets/khameleon/light-product-1.png'},
  '2': {src: 'https://lookaside.facebook.com/assets/khameleon/light-product-4.png'},
  '3': {src: 'https://lookaside.facebook.com/assets/khameleon/light-product-5.png'},
};
...
// ── Styles ────────────────────────────────────────────────────────────────────
// Plain inline styles using Khameleon design-token CSS variables (declared at
// :root by `@khameleon/core/khameleon.css`). No StyleX compiler required.
