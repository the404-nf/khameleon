      ...
      content: [
        {
          ...
          code: 'npm install @khameleon/theme-neutral',
        },
        {
          type: 'code',
          lang: 'tsx',
          label: 'Basic theme setup (runtime injection)',
          code: `import {Theme} from '@khameleon/core';
...
function App() {
  ...
  category: 'guide',
      content: [
        {
          type: 'prose',
          text: 'Install the theme package you want with `npm install @khameleon/theme-{name}`, then import its theme object as shown below.',
        },
        {
          type: 'table',
        ...
        {
          type: 'prose',
          text: 'All theme packages export from two subpaths:\n- `@khameleon/theme-{name}`: source theme (runtime injection)\n- `@khameleon/theme-{name}/built`: pre-built theme (pair with `theme.css`)',
        },
      ],
    },
    {
  ...
  category: 'guide',
      content: [
        ...
        },
        {
          ...
          code: `import {defineTheme} from '@khameleon/core/theme';
...
const brandTheme = defineTheme({
  ...
  button: {
    base: { '--button-press-scale': 'scale(0.95)' },
        ...
        {
          type: 'prose',
          text: 'Run `npx khameleon component <Name>` to see a component\'s theming targets, public CSS variables, and which standard CSS properties are supported.',
        },
        {
          type: 'list',
          style: 'do',
        ...
        },
        {
          ...
          style: 'dont',
          items: [
            'Set private CSS vars (prefixed --_) directly. Use standard CSS properties instead. `khameleon theme build` will error.',
          ],
        },
      ],
    },
  ...
  category: 'guide',
      content: [
        {
          type: 'prose',
          text: 'Themes can add new prop values to any component. Any `prop:value` key where the value isn\'t a built-in gets treated as a new variant. Use `khameleon theme build` to generate TypeScript augmentations for type safety.',
        },
        {
          type: 'code',
          lang: 'tsx',
    ...
    'status:neutral': {
      ...
      color: 'var(--color-text-secondary)',
        ...
        },
        {
          ...
          code: `// TypeScript knows about 'primary-muted' after khameleon theme build
...
<Banner status="neutral" title="Note" />`,
  ...
  category: 'guide',
      content: [
        {
          type: 'prose',
          text: '`npx khameleon theme build` compiles a defineTheme file into production-ready artifacts. Recommended for SSR apps (Next.js, Remix) where styles must be present on first paint.',
        },
        {
          type: 'code',
          lang: 'bash',
          label: 'Build a theme',
          code: 'npx khameleon theme build ./src/themes/ocean.ts',
        },
        {
          type: 'prose',
      ...
      content: [
        ...
        },
        {
          ...
          rows: [
            [
              ...
              "@khameleon/theme-{name}",
              "@khameleon/theme-{name}/built + theme.css",
            ],
            [
              'Import (custom theme)',
              'defineTheme() directly',
              "Built .js + .css from `npx khameleon theme build`",
            ],
            [
              'How it works',
        ...
        },
        {
          ...
          items: [
            ...
            'Run `npx khameleon theme build` for custom themes to get the built artifacts.',
          ],
        },
        {
          type: 'list',
  ...
  category: 'guide',
      content: [
        ...
        },
        {
          ...
          code: `import {tokenVar, tokenVars} from '@khameleon/core/theme/tokens';
  ...
  spacing: {
    4: tokenVars['--spacing-4'],
        ...
        },
        {
          ...
          code: `import {resolveThemeTokens} from '@khameleon/core/theme/tokens';
import {neutralTheme} from '@khameleon/theme-neutral';
...
const chartTheme = {
  ...
  seriesColor: lightTokens['--color-data-categorical-blue'],
        ...
        {
          type: 'prose',
          text: 'The `@khameleon/core/theme/tokens` subpath is server-safe and does not require React. The main `@khameleon/core/theme` barrel also re-exports these helpers for client code that already imports theme APIs.',
        },
      ],
    },
    {
...
function ChartConfig() {
  ...
  return <Chart options={options} />;
        ...
        {
          type: 'prose',
          text: 'See `npx khameleon docs styling-libraries` for styling-library interop and `npx khameleon docs tokens` for the full token reference.',
        },
      ],
    },
  ],
