...
export const docs = {
      ...
      content: [
        {
          ...
          items: [
            ...
            'Layout is frame-first: pick the shell and budget regions before writing content (see \`npx khameleon docs layout\`)',
            'Dense data renders as rows (Table, List/Item), edge-to-edge with dividers; Card is for widgets, galleries, and settings groups',
            'StyleX or Tailwind for custom styling; both are first-class (see \`npx khameleon docs styling\`)',
            'Semantic tokens, not hardcoded values (see \`npx khameleon docs tokens\`)',
  ...
  category: 'guide',
      content: [
        ...
        {
          type: 'prose',
          text: 'See \`npx khameleon docs styling\` for the complete guide with examples.',
        },
      ],
    },
    {
      ...
      content: [
        {
          ...
          items: [
            ...
            'Wrapping every list item or page section in a Card. Decide the frame first; dense data renders as rows (see \`npx khameleon docs layout\`)',
  ...
  category: 'guide',
      content: [
        {
          type: 'prose',
          text: 'The design system provides semantic design tokens for spacing, color, radius, shadow, typography, and size. Tokens adapt to the active theme and color mode. Run \`npx khameleon docs tokens\` for the full reference with all values.',
        },
      ],
    },
  ],
