...
export const docsZh = {
  ...
  sections: [
    ...
    { title: '可用主题', content: [null, null, { type: 'prose', text: '已发布主题：neutral（推荐起点）、butter、chocolate、gothic（仅暗色）、matcha、stone、y2k。@khameleon/theme-{name} = 源码版（运行时注入）。@khameleon/theme-{name}/built = 优化版（配合 theme.css）。' }] },
    ...
    { title: '生产构建', content: [{ type: 'prose', text: 'npx khameleon theme build 将 defineTheme 编译为静态 CSS。输出 .css + .js（__built:true）+ .d.ts。' }, null, null, null, null] },
