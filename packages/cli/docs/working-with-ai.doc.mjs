    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          code: 'Install @khameleon/cli and run `npx khameleon init --features agents` to set up your Khameleon context. Read the generated file.',
        },
        {
          type: 'prose',
        ...
        },
        {
          ...
          code: `npx khameleon init --features agents --agent claude    # CLAUDE.md
npx khameleon init --features agents --agent cursor    # .cursorrules
npx khameleon init --features agents --agent codex     # AGENTS.md (Copilot, Codex, etc.)`,
        },
      ],
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          style: 'ordered',
          items: [
            '`npx khameleon template --list`: find a related page pattern to use as reference',
            '`npx khameleon template <name> --skeleton`: study the layout structure',
            '`npx khameleon component <Name>`: read props and examples for every component used',
          ],
        },
        {
          type: 'prose',
...
npx khameleon init --features agents --agent-docs-path ~/.cursor/rules/xds.mdc`,
        },
      ],
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          lang: 'text',
          label: 'Paste this into your AI',
          code: `Before writing any Khameleon code, check your knowledge:
...
If you don't know all three, run \`npx khameleon init --features agents\` to generate agent docs, then read the generated file.`,
        },
      ],
    },
    {
      title: 'The npx khameleon Pattern',
      content: [
        {
          type: 'prose',
          text: 'AI agents frequently invoke the CLI with incorrect paths (e.g. node_modules/@khameleon/cli/bin/docs.mjs instead of khameleon.mjs), leading to silent failures. Adding an npm script alias with the correct path eliminates this entirely.',
        },
        {
          type: 'code',
          lang: 'json',
  ...
  "khameleon": "node node_modules/@khameleon/cli/bin/khameleon.mjs"
        ...
        {
          type: 'prose',
          text: 'With this alias, agents use `npx khameleon component --list` instead of guessing the binary path. The `--` separator is standard npm convention for passing flags to scripts.',
        },
        {
          type: 'code',
          lang: 'bash',
          label: 'Reliable CLI invocation',
          code: `npx khameleon component --list
npx khameleon component Dialog --dense
npx khameleon docs styling --dense
npx khameleon docs tokens --dense`,
        },
      ],
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          code: `npx khameleon component Dialog --dense
npx khameleon docs styling --dense
npx khameleon docs tokens --dense`,
        },
      ],
    },
    {
      ...
      content: [
        {
          type: 'prose',
          text: 'Khameleon ships a Model Context Protocol (MCP) server that any MCP-compatible AI tool can connect to. Instead of manually pasting CLI output, the AI can query the Khameleon design system directly, searching for components, reading full documentation, and pulling code examples on demand.',
        },
        {
          type: 'prose',
  ...
  "mcpServers": {
    "xds": {
      "type": "url",
      "url": "https://khameleon.the404.dev/mcp"
    }
  }
}`,
        },
