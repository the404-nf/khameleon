...
export const docs = {
  ...
  category: 'guide',
  description:
    'What browsers Khameleon targets, which modern platform features it depends on, and how to support older browsers for your own audience.',
  ...
  sections: [
    {
      ...
      content: [
        {
          type: 'prose',
          text: 'Khameleon is built on modern web platform features: the Popover API, CSS anchor positioning, and CSS `light-dark()`. These let components stay small, accessible, and dependency-free, but they also set a floor on which browsers render everything correctly.',
        },
        {
          type: 'prose',
          text: 'A design system does not own its traffic; the products built on it do. Their audiences range from evergreen-Chrome-only internal tools to public sites with meaningful older-Safari share. So Khameleon does not declare a single hard browser floor the way an app would. Instead it defines tiers that describe what works at each level, and hands the final decision to you. Pick the tier that matches your audience.',
        },
      ],
    },
    {
      ...
      content: [
        {
          type: 'prose',
          text: 'Khameleon officially supports Tier 1 and Tier 2. Tier 3 is best-effort: components will not crash, but positioning and theming may degrade.',
        },
        {
          type: 'table',
    ...
    },
    {
      ...
      content: [
        {
          type: 'prose',
          text: 'Only three modern features carry a browser requirement. Everything else Khameleon uses (`:has()`, `color-mix()`, container queries, the `<dialog>` element) has been widely available since 2023 or earlier and needs no special handling.',
        },
        {
          type: 'table',
          headers: ['Feature', 'Role in Khameleon', 'Widely available'],
          rows: [
            [
    ...
    {
      title: 'What Khameleon Guarantees',
      content: [
        {
          type: 'list',
          style: 'do',
        ...
        },
        {
          ...
          style: 'dont',
          items: [
            'Khameleon does not guarantee correct layer positioning below Tier 1 (anchor positioning). Closing that gap for a Tier 2 audience is a consumer choice; see below.',
            'Khameleon does not ship a `light-dark()` fallback, so theme colors are not guaranteed below Tier 2.',
          ],
        },
      ],
    },
    {
      ...
      content: [
        {
          type: 'prose',
          text: 'If your audience includes Tier 2 browsers and you need correct layer positioning, you have three options, cheapest first. All of them are decisions you make for your audience; Khameleon does not impose one.',
        },
        {
          type: 'list',
          style: 'ordered',
