    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          code: `npx khameleon docs migration
npx khameleon docs theme
npx khameleon docs styling
npx khameleon template --list --type block
npx khameleon template AppShellTopNavWithSideNav --skeleton
npx khameleon template PopoverSettingsPanel --skeleton
npx khameleon component AppShell
npx khameleon component SideNav
npx khameleon component TopNav
npx khameleon component CommandPalette
npx khameleon component Button
npx khameleon component TextInput`,
        },
        {
          type: 'prose',
        ...
        },
        {
          ...
          code: `npx khameleon docs migration --dense
npx khameleon component Button --json`,
        },
      ],
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          code: `import {Theme} from '@khameleon/core/theme';
...
@import "tailwindcss/utilities.css" layer(utilities);`,
        ...
        },
        {
          ...
          code: `@layer reset, tw-preflight, khameleon-base, khameleon-theme;
...
@layer tw-preflight {
  @tailwind base; /* layered: khameleon-theme now wins over preflight */
}
@tailwind components;
...
@import "./legacy-reset.css" layer(reset);`,
        ...
        },
        {
          ...
          items: [
            ...
            'Remove or demote the app legacy reset. The design system ships its own :where() reset in the lowest layer, so any app reset belongs in that same reset layer and never in a layer above khameleon-base.',
            ...
            'Set moduleResolution to bundler or node16 and newer so subpath imports like @khameleon/core/reset.css resolve.',
...
import {VStack} from '@khameleon/core/VStack';
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          code: `We are migrating this existing Tailwind/shadcn app to Khameleon incrementally.

First run:
- npx khameleon docs migration --dense
- npx khameleon docs theme --dense
- npx khameleon docs styling --dense
- npx khameleon template AppShellTopNavWithSideNav --skeleton

Then migrate one route or shell surface at a time. Keep business logic and routing intact. Replace shadcn/Radix/Tailwind primitives with Khameleon components, remove hardcoded colors, verify light and dark mode, and take screenshots before moving to the next surface.`,
        },
      ],
    },
  ],
