 ...
 * docs keep loading unchanged. Kept free of any `@khameleon/core` import so
 * the hot path that loads them (doc discovery, `khameleon init`) does not require
 * core's built `dist/`. The authoring factories live in
 * `@khameleon/core/authoring` and are re-exported from `../doc.mjs` for the
 * public `@khameleon/cli/doc` surface.
 */
 ...
 * `@khameleon/core/docs-types`. Only `name`, `type`, and `description` are
