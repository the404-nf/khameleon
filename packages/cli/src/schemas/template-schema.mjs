 ...
 * `@khameleon/core` import so the hot path that loads them (template
 * discovery, `khameleon init`) does not require core's built `dist/`. The
 * authoring factories live in `@khameleon/core/authoring` and are re-exported
 * from `../template.mjs` for the public `@khameleon/cli/template` surface.
 */
