...
export interface ComponentListEntry {
  name: string;
  /** Owner package, e.g. '@khameleon/core' or '@acme/khameleon-meta'. */
  package: string;
}
...
export interface ComponentOwnership {
  /** Owner package, e.g. '@khameleon/core' or an integration package name. */
  package: string;
  /** Import specifier for the component (e.g. '@khameleon/core/Button'). */
  import: string;
