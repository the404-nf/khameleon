 ...
 * to exist: `khameleon component Button --zh` silently omitted `isInterruptible`
...
describe('the reported symptom', () => {
  it('khameleon component Button --zh still lists isInterruptible and isIconOnly', async () => {
