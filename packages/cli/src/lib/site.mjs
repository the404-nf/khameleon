...
/**
 * @file site.mjs — the canonical Khameleon site origin for CLI code.
 *
 * The published Khameleon site is the single source of truth for docs, the blog,
...
export const SITE_URL = 'https://khameleon.the404.dev';
