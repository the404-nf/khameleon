...
class Emitter {
  ...
  emitHint(hint, depth) {
    ...
    if (hint.block) {
      ...
      return [
        `${pad}{/* TODO(xle): content block '${hint.block.name}'${flags}${arg} — scaffold it with: khameleon template ${hint.block.name} */}`,
      ];
    }
...
export function expand(doc, registry, options = {}) {
  ...
  const code = [
    `// Generated by \`khameleon layout expand\` — this file is the artifact; edit freely.`,
    ...importLines,
    ...blockSection,
    '',
