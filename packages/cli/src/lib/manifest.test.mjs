 ...
 *      are described once, and the bare `xds --json` / `khameleon manifest --json`
...
describe('manifest: shape', () => {
  it('has top-level metadata', () => {
    expect(manifest.name).toBe('khameleon');
