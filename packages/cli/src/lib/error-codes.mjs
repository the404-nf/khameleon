...
/**
 * @file Khameleon CLI — stable machine-readable error codes.
 *
 * ## Why codes exist
 *
 ...
 * command, the API layer (`KhameleonError`), or Commander's own parse machinery —
 ...
 *   throw new KhameleonError('No component named "Buton"', suggestions, ERROR_CODES.ERR_UNKNOWN_COMPONENT);
 *
...
/**
 * The complete, frozen set of Khameleon CLI error codes. Append-only.
...
export const ERROR_CODES = Object.freeze({
  ...
  /** A top-level command name was not recognized (e.g. `khameleon bogus`). */
  ERR_UNKNOWN_COMMAND: 'ERR_UNKNOWN_COMMAND',
  /** A subcommand under a command group was not recognized (e.g. `khameleon theme bogus`). */
  ...
  /** `@khameleon/core` could not be located (not installed / not in a monorepo). */
  ...
  // ── Upgrade ──────────────────────────────────────────────────────
  /** The current `@khameleon/core` version could not be detected. */
