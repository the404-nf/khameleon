...
/**
 * @file Khameleon CLI — central error handling helper.
 *
 * ## Exit-code policy
 *
 * The Khameleon CLI follows one rule above all: **exit code is the contract**. CI
 ...
 *      default (e.g. `khameleon component` lists all components, `khameleon docs` lists
