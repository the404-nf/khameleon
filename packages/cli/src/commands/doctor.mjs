...
/**
 * @file `khameleon doctor` command — diagnose a project + environment and report
 ...
 * FAILs (warnings are fine), 1 when any check FAILs — so `khameleon doctor` works
 * as a CI gate.
 */
...
function printHuman(report) {
  humanLog('khameleon doctor — diagnosing your setup\n');
...
/**
 * Register the `khameleon doctor` command.
