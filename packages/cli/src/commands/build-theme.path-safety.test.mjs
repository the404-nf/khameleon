...
/**
 * @file Path-safety regression tests for `khameleon theme build`.
 *
 * Covers:
...
function writeTheme(dir, name) {
  ...
  // without needing jiti / TS, and without depending on @khameleon/core being
...
let tmpDir;
beforeEach(() => {
  tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), 'khameleon-build-theme-paths-'));
});
afterEach(() => {
