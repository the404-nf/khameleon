...
/**
 * @file Regression test for `khameleon theme build` install-instructions import paths.
 *
...
// `khameleon theme build` imports the compiled @khameleon/core/theme entry (there is no
...
let tmpDir;
beforeEach(() => {
  tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), 'khameleon-build-theme-import-path-'));
});
afterEach(() => {
