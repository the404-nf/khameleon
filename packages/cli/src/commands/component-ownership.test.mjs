...
// under `node_modules`, so a real khameleon.config.mjs at a tmp root cannot be
 ...
 * - packages/core symlinked to the real @khameleon/core (loadDocs source)
...
beforeEach(() => {
  tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), 'khameleon-ownership-'));
