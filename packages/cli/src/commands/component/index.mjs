      ...
      switch (result.type) {
        case 'component.list': {
          ...
          if (options.category) {
            ...
            humanLog('');
            humanLog(`Import from the path shown (e.g. import {Button} from '@khameleon/core/Button')`);
            humanLog(`Usage: ${run} khameleon component <name>`);
            humanLog('');
          }
          break;
        }
