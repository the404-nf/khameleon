 ...
 *
 * `KhameleonError` is what the API layer throws. Alongside the human-readable
 * message and optional `suggestions`, it carries a stable machine-readable
 * `code` (see ../lib/error-codes.mjs). When the CLI catches an KhameleonError and
...
export class KhameleonError extends Error {
