...
describe('stripTemplateAssetRefs', () => {
  it('replaces a lookaside khameleon image URL with an inline data URI', () => {
    const src =
      "const hero = 'https://lookaside.facebook.com/assets/khameleon/colorful-home-horizontal-1.png';";
  ...
  it('replaces a lookaside block-avatar image URL', () => {
    const src =
      'src="https://lookaside.facebook.com/assets/khameleon/avatar-profile-05.jpg"';
    const out = stripTemplateAssetRefs(src);
    expect(out).not.toContain('lookaside.facebook.com');
    expect(out).toContain('data:image/svg+xml,');
  });
  ...
  it('preserves surrounding source structure', () => {
    const src =
      "const data = [{src: 'https://lookaside.facebook.com/assets/khameleon/x.png', alt: 'X'}];";
    const out = stripTemplateAssetRefs(src);
