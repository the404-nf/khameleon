 ...
 *
 * Returns the same typed envelope { type, data } that `khameleon --json hook` outputs.
          ...
          if (docPath) {
            try {
              ...
              entries.push({
                ...
                import: docs.importPath || '@khameleon/core/hooks',
              });
            } catch {
              entries.push({name: hookName, description: '', import: '@khameleon/core/hooks'});
            }
          } else {
            entries.push({name: hookName, description: '', import: '@khameleon/core/hooks'});
          }
        ...
        for (const hookName of hookNames) {
          ...
          if (docPath) {
            try {
              ...
              result[cat].push({name: hookName, description: '', import: '@khameleon/core/hooks'});
            }
          } else {
            result[cat].push({name: hookName, description: '', import: '@khameleon/core/hooks'});
          }
