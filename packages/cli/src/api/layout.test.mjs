...
/**
 * @file Integration tests for the layout API against the real @khameleon/core
...
describe('template referencing', () => {
  it('splices a template block: co-defined once, referenced, imports merged', async () => {
    ...
    expect((code.match(/from '@khameleon\/core\/Card'/g) || [])).toHaveLength(1);
  ...
  it('imports app-registered local components (the local-component bridge)', async () => {
    // Inside the workspace so @khameleon/core resolves; cleaned up after.
