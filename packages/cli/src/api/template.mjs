...
const CORE_PACKAGE = '@khameleon/core';
...
/**
 * Discover blocks from external packages that declare `khameleon.blocks` in
...
export async function template(name, options = {}) {
   ...
   * templates have no `package` field; report them under @khameleon/core.
