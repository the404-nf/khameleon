...
export default [
  {
    ...
    // the specifier codemod then rewrites the paths to `@khameleon/core`.
  ...
  },
  {
    ...
    // codemod: it uses the same @xds -> @khameleon mapping and repairs an
  ...
  },
  {
    ...
    // become their `khameleon-*` forms. Mandatory in v0.1.0.
