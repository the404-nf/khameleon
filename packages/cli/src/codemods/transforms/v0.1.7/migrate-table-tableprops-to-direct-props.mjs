 ...
 * @see https://github.com/the404-nf/khameleon/issues/3679
 *
 ...
 * from an Khameleon core source are rewritten. No import changes are needed.
 */
...
/** Import sources that provide the Khameleon Table component. */
const TABLE_IMPORT_SOURCES = new Set([
  '@khameleon/core',
  '@khameleon/core/Table',
  '@xds/core',
  '@xds/core/Table',
]);
...
const TODO_COMMENT =
  ' TODO(khameleon): tableProps is deprecated — merge these into direct props manually ';
