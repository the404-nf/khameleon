 ...
 * Config codemods target the consumer's khameleon.config.* file; code codemods
 ...
 * implementation of "run a config codemod against khameleon.config.*" and "run a
 ...
 * first (targeting khameleon.config.*), then code codemods (source globbing).
 *
