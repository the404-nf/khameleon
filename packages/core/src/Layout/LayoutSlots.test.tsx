...
describe('LayoutHeader', () => {
  ...
  it('carries the khameleon-layout-header class', () => {
    const {container} = render(<LayoutHeader>H</LayoutHeader>);
    expect(
      container.querySelector('.khameleon-layout-header'),
    ).toBeInTheDocument();
  });
  ...
  it('omits data-divider by default', () => {
    ...
    expect(
      container
        .querySelector('.khameleon-layout-header')
  ...
  it('applies a numeric height to the element style', () => {
    ...
    const el = container.querySelector('.khameleon-layout-header') as HTMLElement;
  ...
  it('forwards ref to the outer element', () => {
    ...
    expect(ref.current?.className).toContain('khameleon-layout-header');
  });
...
describe('LayoutFooter', () => {
  ...
  it('carries the khameleon-layout-footer class', () => {
    const {container} = render(<LayoutFooter>F</LayoutFooter>);
    expect(
      container.querySelector('.khameleon-layout-footer'),
    ).toBeInTheDocument();
  });
  ...
  it('omits data-divider by default and reflects hasDivider when set', () => {
    ...
    const sel = '.khameleon-layout-footer';
  ...
  it('inherits the divider default from context', () => {
    ...
    expect(
      container
        .querySelector('.khameleon-layout-footer')
        ?.getAttribute('data-divider'),
    ).toBe('true');
  });
  ...
  it('forwards ref to the outer element', () => {
    ...
    expect(ref.current).toBeInstanceOf(HTMLDivElement);
    expect(ref.current?.className).toContain('khameleon-layout-footer');
  });
});
...
describe('LayoutContent', () => {
  ...
  it('carries the khameleon-layout-content class', () => {
    const {container} = render(<LayoutContent>C</LayoutContent>);
    expect(
      container.querySelector('.khameleon-layout-content'),
    ).toBeInTheDocument();
  });
  ...
  it('forwards ref to the element', () => {
    ...
    expect(ref.current).toBeInstanceOf(HTMLDivElement);
    expect(ref.current?.className).toContain('khameleon-layout-content');
  });
  ...
  it('merges caller className and inline style', () => {
    ...
    const el = container.querySelector('.khameleon-layout-content') as HTMLElement;
...
describe('LayoutPanel', () => {
  ...
  it('carries the khameleon-layout-panel class', () => {
    const {container} = render(<LayoutPanel>P</LayoutPanel>);
    expect(container.querySelector('.khameleon-layout-panel')).toBeInTheDocument();
  });
  ...
  it('applies a numeric width to the element style', () => {
    ...
    const el = container.querySelector('.khameleon-layout-panel') as HTMLElement;
  ...
  it('forwards ref to the element', () => {
    ...
    expect(ref.current).toBeInstanceOf(HTMLDivElement);
    expect(ref.current?.className).toContain('khameleon-layout-panel');
  });
