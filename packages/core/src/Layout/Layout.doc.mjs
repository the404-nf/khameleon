...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'khameleon-layout', visualProps: ['height']},
      {className: 'khameleon-layout-content'},
      {className: 'khameleon-layout-footer'},
      {className: 'khameleon-layout-header'},
      {className: 'khameleon-layout-panel'},
    ],
  },
