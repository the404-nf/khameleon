...
/**
 * Propagation styles for --khameleon-section-padding.
...
export const sectionPaddingPropagationStyles = stylex.create({
  0: {'--khameleon-section-padding': spacingVars['--spacing-0']},
  0.5: {'--khameleon-section-padding': spacingVars['--spacing-0-5']},
  1: {'--khameleon-section-padding': spacingVars['--spacing-1']},
  1.5: {'--khameleon-section-padding': spacingVars['--spacing-1-5']},
  2: {'--khameleon-section-padding': spacingVars['--spacing-2']},
  3: {'--khameleon-section-padding': spacingVars['--spacing-3']},
  4: {'--khameleon-section-padding': spacingVars['--spacing-4']},
  5: {'--khameleon-section-padding': spacingVars['--spacing-5']},
  6: {'--khameleon-section-padding': spacingVars['--spacing-6']},
  8: {'--khameleon-section-padding': spacingVars['--spacing-8']},
  10: {'--khameleon-section-padding': spacingVars['--spacing-10']},
});
