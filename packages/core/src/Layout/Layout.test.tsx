...
describe('Layout', () => {
  ...
  describe('theme props (class + data attributes)', () => {
    it('renders the khameleon-layout class on the root', () => {
      const {container} = render(<Layout content={<div>x</div>} />);
      expect(root(container).className).toContain('khameleon-layout');
    });
  ...
  describe('defaultHasDividers → LayoutDividerContext', () => {
    ...
    it('makes footers default to having a divider', () => {
      ...
      expect(
        container.querySelector('.khameleon-layout-footer[data-divider]'),
      ).not.toBeNull();
    });
    ...
    it('does not force dividers when defaultHasDividers is unset', () => {
      ...
      expect(
        container.querySelector('.khameleon-layout-header[data-divider]'),
      ).toBeNull();
    });
  ...
  describe('styling & ref', () => {
    it('forwards ref to the root div', () => {
      ...
      expect(ref.current?.className).toContain('khameleon-layout');
    });
