...
> = {
  sending: {icon: 'clock', i18nKey: '@khameleon.chat.status.sending'},
  sent: {icon: 'check', i18nKey: '@khameleon.chat.status.sent'},
  delivered: {icon: 'checkDouble', i18nKey: '@khameleon.chat.status.delivered'},
  read: {icon: 'checkDouble', i18nKey: '@khameleon.chat.status.read'},
  error: {icon: 'error', i18nKey: '@khameleon.chat.status.failed'},
};
  ...
  return (
    <div
      ...
      {statusConfig != null && (
        <span
          title={statusLabel}
          aria-label={t('@khameleon.chat.messageAriaLabel', {
