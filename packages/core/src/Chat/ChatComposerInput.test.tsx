...
describe('ChatComposerInput', () => {
  ...
  describe('selection recovery (no range inside editable)', () => {
    ...
    it('paste inserts a token chip for long pastes after a focus() with no selection range', () => {
      ...
      expect(textbox.querySelector('[data-khameleon-token]')).toBeInTheDocument();
    });
    ...
    it('paste falls through to plain-text path when pasteAsToken={false}', () => {
      ...
      expect(
        textbox.querySelector('[data-khameleon-token]'),
  ...
  describe('refs', () => {
    it('forwards ref to the root element', () => {
      ...
      expect(root).toHaveClass('khameleon-chat-composer-input');
    });
  ...
  describe('token backspace handling', () => {
    it('removes token and trailing NBSP on backspace', () => {
      ...
      const tokenSpan = textbox.querySelector('[data-khameleon-token]');
      ...
      expect(textbox.querySelector('[data-khameleon-token]')).toBeNull();
    });
  ...
  describe('khameleon class names', () => {
    it('has khameleon-chat-composer-input class', () => {
      const {container} = render(<ChatComposerInput />);
      expect(
        container.querySelector('.khameleon-chat-composer-input'),
      ).toBeInTheDocument();
    });
  });
  ...
  describe('trigger menu cursor anchor', () => {
    ...
    const BODY_ANCHOR_SELECTOR = 'span[data-khameleon-trigger-anchor]';
