...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'khameleon-chat-layout', visualProps: ['density']},
      {className: 'khameleon-chat-composer', visualProps: ['density']},
      {className: 'khameleon-chat-composer-input'},
      {className: 'khameleon-chat-composer-drawer', visualProps: ['collapsed']},
      {className: 'khameleon-chat-message', visualProps: ['sender', 'density']},
      {
        className: 'khameleon-chat-message-bubble',
        visualProps: ['sender', 'variant', 'density'],
      },
      {className: 'khameleon-chat-message-list', visualProps: ['density']},
      {className: 'khameleon-chat-system-message', visualProps: ['variant']},
      {className: 'khameleon-chat-message-metadata'},
      {className: 'khameleon-chat-send-button'},
      {className: 'khameleon-chat-tokenized-text'},
      {className: 'khameleon-chat-tool-calls'},
      {className: 'khameleon-trigger-menu'},
    ],
    vars: [
