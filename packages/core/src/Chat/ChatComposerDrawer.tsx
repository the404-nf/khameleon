...
export function ChatComposerDrawer({
  ...
  const label = labelFromProps ?? t('@khameleon.chat.composerDrawer.label');
    ...
    <div
      ...
      {canCollapse && (
        <div
          ...
          aria-label={
            isCollapsed
              ? t('@khameleon.chatComposerDrawer.expand', {label})
              : t('@khameleon.chatComposerDrawer.collapse', {label})
          }
          onClick={toggle}
          onKeyDown={e => {
