...
export const docs = {
  ...
  props: [
    ...
    },
    {
      name: 'startIcon',
      type: 'IconType',
      description: 'Icon to display at the start of the input. See `npx khameleon docs icons` for valid semantic names.',
    },
    {
      name: 'labelIcon',
      type: 'IconType',
  ...
  theming: {
    targets: [
      {className: 'khameleon-number-input', visualProps: ['size', 'status']},
    ],
  },
  usage: {
    description:
