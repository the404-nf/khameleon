...
export const docs = {
  ...
  playground: {
    defaults: {
      children: '## Getting Started\n\nInstall the package:\n\n```bash\nnpm install @khameleon/core\n```\n\nThen import and use any component:\n\n```tsx\nimport {Button} from \'@khameleon/core/Button\';\n```\n\n**Bold**, *italic*, and `inline code` all work.',
    },
  },
  theming: {
    targets: [
      {className: 'khameleon-markdown', visualProps: ['density']},
    ],
  },
  usage: {
    description:
      'Renders a markdown string as Khameleon-styled components. Use Markdown for user-generated content, AI responses, and documentation; it handles headings, lists, tables, code blocks, and citations with consistent styling.',
    bestPractices: [
...
export const docsDense = {
  description:
    'Renders markdown string as Khameleon-styled components. Use for user-generated content, AI responses, docs. Headings, lists, tables, code, citations w/ consistent styling.',
  usage: {
    description:
      'Renders a markdown string as Khameleon-styled components. Use Markdown for user-generated content, AI responses, and documentation; it handles headings, lists, tables, code blocks, and citations with consistent styling.',
    bestPractices: [
