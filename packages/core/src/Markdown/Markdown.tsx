 ...
 * @position Core implementation; renders markdown as Khameleon components
 */
      ...
      if (isTaskList) {
        ...
        return (
          <div
            ...
            <CheckboxList
              label={t('@khameleon.markdown.taskList')}
              isLabelHidden
              value={checkedValues}
    ...
    case 'table': {
      ...
      return (
        <div
          ...
          tabIndex={0}
          role="group"
          aria-label={t('@khameleon.markdown.table')}
          {...stylex.props(
            styles.tableWrapper,
            spacing,
            contentWidthValue != null
...
/**
 * Renders a markdown string as Khameleon components. Supports streaming with
