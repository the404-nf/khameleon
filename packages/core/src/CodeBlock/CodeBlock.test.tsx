...
function politeRegion(): HTMLElement | null {
  return document.querySelector('[data-khameleon-live-region="polite"]');
}
...
describe('CodeBlock', () => {
  ...
  it('applies a per-instance syntax theme via the syntaxTheme prop', () => {
    ...
    const wrapper = container.querySelector('[data-khameleon-syntax-theme]');
    expect(wrapper).not.toBeNull();
    expect(wrapper).toHaveAttribute('data-khameleon-syntax-theme', 'dracula');
  ...
  it('renders no syntax theme wrapper when syntaxTheme is not set', () => {
    ...
    expect(container.querySelector('[data-khameleon-syntax-theme]')).toBeNull();
