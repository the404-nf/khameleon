...
export const docs = {
  ...
  props: [
    ...
    },
    {
      ...
      description: 'Per-instance syntax theme override. Shorthand for wrapping the block in <SyntaxTheme theme={...}>. Accepts a preset from @khameleon/core/theme/syntax or a theme created with defineSyntaxTheme(). Defaults to the nearest SyntaxTheme ancestor or the theme-level syntax colors.',
    },
    {
      name: 'isCollapsible',
      type: 'boolean',
  ...
  theming: {
    targets: [
      {className: 'khameleon-code', visualProps: ['color']},
      {className: 'khameleon-codeblock', visualProps: ['size', 'language', 'container']},
    ],
  },
  usage: {
