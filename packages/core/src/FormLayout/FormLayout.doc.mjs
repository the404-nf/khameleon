...
export const docs = {
  ...
  props: [
    ...
    },
    {
      ...
      type: 'ReactNode',
      description:
        'Form fields to arrange. Accepts Khameleon inputs (TextInput, Selector, etc.) and Field-wrapped custom controls.',
    },
    {
      name: 'xstyle',
      type: 'StyleXStyles',
  ...
  theming: {
    targets: [
      {className: 'khameleon-form-layout', visualProps: ['direction']},
    ],
  },
  usage: {
...
export const docsZh = {
  ...
  props: [
    ...
    },
    {
      ...
      type: 'ReactNode',
      description:
        '要排列的表单字段。接受 Khameleon 输入组件（TextInput、Selector 等）和 Field 包装的自定义控件。',
    },
    {
      name: 'xstyle',
      type: 'StyleXStyles',
...
export const docsDense = {
  ...
  propDescriptions: {
    ...
    children: 'Form fields to arrange. Accepts Khameleon inputs + Field-wrapped custom controls.',
