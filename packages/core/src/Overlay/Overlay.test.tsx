...
describe('Overlay', () => {
  describe('rendering & structure', () => {
    ...
    it('renders a root div carrying the khameleon-overlay class', () => {
      ...
      expect(root.className).toContain('khameleon-overlay');
    });
    ...
    it('applies the khameleon-overlay-scrim class to the scrim', () => {
      const {container} = render(
        <Overlay content={<span>c</span>}>
          <div>b</div>
        </Overlay>,
      );
      expect(getScrim(container).className).toContain('khameleon-overlay-scrim');
    });
  });
  ...
  describe('scrim mode → media theme inversion', () => {
    it('dark scrim (default) wraps content in a dark MediaTheme', () => {
      ...
      expect(
        container.querySelector('[data-khameleon-media="dark"]'),
      ).toBeInTheDocument();
    });
    ...
    it('light scrim wraps content in a light MediaTheme', () => {
      ...
      expect(
        container.querySelector('[data-khameleon-media="light"]'),
      ).toBeInTheDocument();
      expect(
        container.querySelector('[data-khameleon-media="dark"]'),
    ...
    it('scrim={false} renders no MediaTheme wrapper', () => {
      ...
      expect(
        container.querySelector('[data-khameleon-media]'),
      ).not.toBeInTheDocument();
    });
  });
  ...
  describe('styling & ref', () => {
    it('forwards ref to the root div element', () => {
      ...
      expect(ref.current?.className).toContain('khameleon-overlay');
    });
