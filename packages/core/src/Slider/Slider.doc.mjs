...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'khameleon-slider', visualProps: ['orientation'], states: ['disabled']},
      {className: 'khameleon-slider-track', visualProps: ['orientation']},
      {className: 'khameleon-slider-thumb', visualProps: ['orientation'], states: ['disabled']},
    ],
  },
  usage: {
    description:
