...
export const docs = {
  ...
  props: [
    ...
    },
    {
      ...
      type: 'IconType',
      description:
        'Icon component rendered inside the leading edge of the textarea wrapper. See `npx khameleon docs icons` for valid semantic names.',
    },
    {
      name: 'hasSpellCheck',
      type: 'boolean',
  ...
  theming: {
    targets: [
      {className: 'khameleon-textarea', visualProps: ['size', 'status']},
    ],
  },
  usage: {
    description:
