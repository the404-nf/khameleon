 ...
 */
export interface KhameleonBaseDocInput {
...
export interface KhameleonPropInput {
  name: string;
  type: string;
  description: string;
  default?: string;
...
export interface KhameleonParamInput {
  name: string;
  type: string;
  description: string;
  default?: string;
...
export interface KhameleonReturnInput {
  name: string;
  type: string;
  description: string;
  [key: string]: unknown;
 ...
 */
export interface KhameleonComponentDocInput extends KhameleonBaseDocInput {
  /** All public props for the component. */
  props: KhameleonPropInput[];
 ...
 */
export interface KhameleonFunctionDocInput extends KhameleonBaseDocInput {
  /** Function/hook parameters or options-object fields. */
  params: KhameleonParamInput[];
  /** Return value documentation. One entry per field (or a single primitive). */
  returns: KhameleonReturnInput[];
}
 ...
 */
export type KhameleonGenericDocInput = KhameleonBaseDocInput;
 ...
 */
export type KhameleonComponentDoc =
 ...
 */
export function createComponentDoc<T extends KhameleonComponentDocInput>(
  def: T,
): T & {type: 'component'} {
 ...
 * CLI load boundary.
 */
export function createFunctionDoc<T extends KhameleonFunctionDocInput>(
  def: T,
): T & {type: 'function'} {
 ...
 */
export function createDoc<T extends KhameleonGenericDocInput>(
  def: T,
): T & {type: 'generic'} {
