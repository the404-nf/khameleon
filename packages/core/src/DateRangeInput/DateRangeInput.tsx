...
export function DateRangeInput({
  ...
  const placeholder =
    placeholderFromProps ?? t('@khameleon.dateRangeInput.placeholder');
  ...
  const popover = usePopover({
    dialogLabel: t('@khameleon.dateRangeInput.dialogLabel'),
      ...
      {popover.render(
        <div {...stylex.props(styles.popoverLayout)}>
          {presets && presets.length > 0 && (
            <div
              role="group"
              aria-label={t('@khameleon.dateRangeInput.presetDateRanges')}
