...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'khameleon-field', visualProps: ['layout']},
      {className: 'khameleon-field-label'},
      {className: 'khameleon-field-status', visualProps: ['type', 'variant']},
    ],
    vars: [
  ...
  props: [
    ...
    },
    {
      name: 'labelIcon',
      type: 'IconType',
      description: 'Icon to display before the label text. See `npx khameleon docs icons` for valid semantic names.',
    },
    {
      name: 'labelTooltip',
      type: 'string',
  ...
  usage: {
    description: 'Field is a low-level wrapper for custom, native, or third-party controls that do not already provide field label, description, and status UI. Use it when you need the Field shell around a control you own; use styled Khameleon inputs like TextInput, Typeahead, and Select directly when they already expose label, description, and validation props.',
    bestPractices: [
