...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'khameleon-calendar', visualProps: ['mode']},
      {className: 'khameleon-calendar-day', states: ['selected', 'today', 'disabled', 'in-range']},
    ],
  },
};
...
export const docsZh = {
  ...
  theming: {
    targets: [
      {
        className: 'khameleon-calendar',
        visualProps: [
          'mode',
        ],
      },
      {
        className: 'khameleon-calendar-day',
        states: [
          'selected',
          'today',
          'disabled',
