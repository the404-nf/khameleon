...
describe('Code', () => {
  ...
  it('defaults color to primary', () => {
    ...
    expect(screen.getByText('code')).toHaveClass('khameleon-code', 'primary');
  });

  it('applies the secondary color', () => {
    render(<Code color="secondary">code</Code>);
    expect(screen.getByText('code')).toHaveClass('khameleon-code', 'secondary');
  });

  it('applies the inherit color', () => {
    render(<Code color="inherit">code</Code>);
    expect(screen.getByText('code')).toHaveClass('khameleon-code', 'inherit');
  });
