...
export const docs = {
  ...
  props: [
    ...
    },
    {
      name: 'labelIcon',
      type: 'IconType',
      description: 'Icon displayed before the label text. See `npx khameleon docs icons` for valid semantic names.',
    },
    {
      name: 'labelTooltip',
      type: 'string',
  ...
  theming: {
    targets: [
      {className: 'khameleon-switch', states: ['checked', 'disabled']},
      {className: 'khameleon-switch-thumb', states: ['checked']},
      {className: 'khameleon-switch-field', visualProps: ['labelPosition', 'labelSpacing']},
    ],
  },
  usage: {
    description:
