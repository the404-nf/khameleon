 ...
 * @output Exports BaseProps — the shared base interface for all Khameleon components
...
/**
 * Base props shared by all Khameleon components.
 *
...
> {
   ...
   * Khameleon component prop/state reflection (for example data-variant/data-size). */
