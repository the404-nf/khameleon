...
export function CommandPalette<T extends SearchableItem = SearchableItem>({
  ...
  const label = labelFromProps ?? t('@khameleon.commandPalette.label');
  const emptySearchText =
    emptySearchTextFromProps ?? t('@khameleon.commandPalette.emptySearch');
  const emptyBootstrapText =
    emptyBootstrapTextFromProps ?? t('@khameleon.commandPalette.emptyBootstrap');
  const listId = useId();
