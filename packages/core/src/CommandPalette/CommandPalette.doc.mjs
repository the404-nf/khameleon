...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'khameleon-command-palette-empty'},
      {className: 'khameleon-command-palette-footer'},
      {className: 'khameleon-command-palette-group'},
      {className: 'khameleon-command-palette-input'},
      {className: 'khameleon-command-palette-item'},
      {className: 'khameleon-command-palette-list'},
    ],
  },
  usage: {
