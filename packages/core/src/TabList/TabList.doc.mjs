...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'khameleon-tab-list', visualProps: ['size']},
      {className: 'khameleon-tab', states: ['selected']},
      {className: 'khameleon-tab-indicator', states: ['selected']},
      {className: 'khameleon-tab-menu'},
      {className: 'khameleon-tab-menu-dropdown'},
      {className: 'khameleon-tab-menu-item'},
    ],
  },
