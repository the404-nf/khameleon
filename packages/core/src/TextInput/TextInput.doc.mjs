...
export const docs = {
  ...
  props: [
    ...
    },
    {
      ...
      type: 'IconType',
      description:
        'SVG icon component displayed at the start of the input. See `npx khameleon docs icons` for valid semantic names.',
    },
    {
      name: 'status',
  ...
  theming: {
    targets: [
      {className: 'khameleon-text-input', visualProps: ['size', 'status']},
    ],
  },
  usage: {
    description:
