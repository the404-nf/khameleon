...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'khameleon-collapsible', visualProps: ['density']},
      {className: 'khameleon-collapsible-group', visualProps: ['density']},
    ],
  },
