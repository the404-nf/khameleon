...
describe('CollapsibleGroup', () => {
  ...
  describe('dividers', () => {
    ...
    it('renders no wrapper DOM by default and with hasDividers={false}', () => {
      ...
      expect(container.querySelector('.khameleon-collapsible-group')).toBeNull();
    ...
    it('renders a wrapper with default density when dividers are enabled', () => {
      ...
      const wrapper = container.querySelector('.khameleon-collapsible-group');
    ...
    it('forwards ref to the wrapper in divider mode', () => {
      ...
      expect(ref.current).toBe(
        container.querySelector('.khameleon-collapsible-group'),
      );
    });
    ...
    it('renders standalone Collapsible without any group chrome', () => {
      ...
      expect(item.querySelector('.khameleon-collapsible-group')).toBeNull();
    });
  });
});
