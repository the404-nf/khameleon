...
export const docs = {
  ...
  usage: {
    ...
    bestPractices: [
      {guidance: true, description: 'Use the hook directly when building custom collapsible components that need Khameleon collapsible behavior without Collapsible wrapper.'},
  ...
  relatedHooks: [],
  importPath: '@khameleon/core/Collapsible',
...
export const docsDense = {
  ...
  usage: {
    description: 'Encapsulates collapsible state machine. 3 modes: group-controlled (inside CollapsibleGroup), controlled (isOpen + onOpenChange), uncontrolled (self-managed w/ defaultIsOpen). Used internally by Card + Section.',
    bestPractices: [
      {guidance: true, description: 'Use directly when building custom collapsible components needing Khameleon collapsible behavior w/o Collapsible wrapper.'},
