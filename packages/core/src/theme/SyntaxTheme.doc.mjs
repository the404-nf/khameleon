  ...
  props: [
    {
      ...
      required: true,
      description:
        'Syntax highlighting theme: a preset from @khameleon/core/theme/syntax or a custom theme created with defineSyntaxTheme().',
    },
    {
      name: 'children',
      type: 'ReactNode',
...
export const docsDense = {
  ...
  propDescriptions: {
    theme:
      'syntax highlighting theme: preset from @khameleon/core/theme/syntax or custom theme created w/ defineSyntaxTheme()',
  },
};
