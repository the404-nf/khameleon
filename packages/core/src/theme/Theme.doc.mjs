...
export const docsDense = {
  usage: {
    description:
      'Wraps subtree w/ specific Khameleon theme. For static production themes, use `npx khameleon theme build` + generated CSS + built theme object for first-paint/SSR performance. Use runtime `defineTheme()` for dynamic themes or prototyping. Token names always start with `--` (e.g. `--color-accent`, `--color-background-surface`).',
    bestPractices: [
      {
        guidance: true,
        description:
          'Build app themes known ahead of time w/ `npx khameleon theme build`; import generated CSS + built theme object.',
      },
      {
        guidance: true,
        description:
