...
describe('Theme', () => {
  beforeEach(() => {
    ...
    document.documentElement.removeAttribute('data-khameleon-theme');
  });
  ...
  it('sets data-khameleon-theme on wrapper div', () => {
    const {container} = render(
      <Theme theme={testTheme}>
        <span>child</span>
      </Theme>,
    );
    const wrapper = container.querySelector('[data-khameleon-theme="test"]');
  ...
  // =========================================================================
  // Root detection — data-khameleon-theme on <html>
  // =========================================================================

  it('syncs data-khameleon-theme to <html> for root provider', () => {
    render(
      <Theme theme={testTheme} mode="light">
        <span>child</span>
      </Theme>,
    );
    expect(document.documentElement.getAttribute('data-khameleon-theme')).toBe(
      'test',
    );
  });

  it('removes data-khameleon-theme from <html> when root provider unmounts', () => {
    const {unmount} = render(
      <Theme theme={testTheme} mode="light">
        <span>child</span>
      </Theme>,
    ...
    unmount();
    expect(document.documentElement.hasAttribute('data-khameleon-theme')).toBe(false);
  });
  ...
  it('does not let nested Theme override <html> data-khameleon-theme', () => {
    render(
      <Theme theme={testTheme} mode="dark">
  ...
  it('nested Theme still sets data-theme on its own wrapper div', () => {
    ...
    const nestedWrapper = container.querySelector('[data-khameleon-theme="alt"]');
