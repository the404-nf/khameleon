...
describe('OverflowList', () => {
  ...
  describe('rendering contract', () => {
    it('renders the stable khameleon-overflow-list class on the visible container', () => {
      render(
      ...
      expect(visibleContainer()).toHaveClass('khameleon-overflow-list');
    });
    ...
    it('forwards a ref to the visible container', () => {
      ...
      expect(el).toHaveClass('khameleon-overflow-list');
    });
