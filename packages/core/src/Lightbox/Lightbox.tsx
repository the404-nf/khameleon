...
export function Lightbox({
  ...
  return (
    <dialog
      ...
      aria-label={currentItem.alt || t('@khameleon.lightbox.mediaViewer')}
      {...mergeProps(
        themeProps('lightbox'),
      ...
      <div {...stylex.props(styles.container)}>
        ...
        <div {...stylex.props(styles.closeButton)}>
          <IconButton
            ...
            label={t('@khameleon.lightbox.close')}
            variant="ghost"
            onClick={handleClose}
        ...
        {isGallery && (
          <div {...stylex.props(styles.navButton, styles.navPrev)}>
            <IconButton
              ...
              label={t('@khameleon.lightbox.previous')}
              variant="ghost"
              isDisabled={!canPrev}
              onClick={goToPrev}
              xstyle={styles.controlButton}
        ...
        {isGallery && (
          <div {...stylex.props(styles.navButton, styles.navNext)}>
            <IconButton
              ...
              label={t('@khameleon.lightbox.next')}
              variant="ghost"
              isDisabled={!canNext}
              onClick={goToNext}
              xstyle={styles.controlButton}
