...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'khameleon-side-nav', visualProps: ['mode']},
      {className: 'khameleon-side-nav-heading'},
      {className: 'khameleon-side-nav-item', visualProps: ['size'], states: ['selected']},
      {className: 'khameleon-side-nav-section'},
    ],
  },
