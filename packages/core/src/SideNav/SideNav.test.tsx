...
describe('SideNav resizable', () => {
  it('renders drag handle when resizable', () => {
    ...
    expect(
      screen.getByTestId('khameleon-sidenav-resize-handle'),
    ).toBeInTheDocument();
  });
  ...
  it('does not render drag handle without resizable', () => {
    render(<SideNav>Content</SideNav>);
    expect(
      screen.queryByTestId('khameleon-sidenav-resize-handle'),
    ).not.toBeInTheDocument();
  });
  ...
  it('calls onWidthChange after drag', () => {
    ...
    const handle = screen.getByTestId('khameleon-sidenav-resize-handle');
