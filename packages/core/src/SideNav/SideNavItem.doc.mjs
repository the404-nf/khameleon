...
export const docs = {
  ...
  props: [
    ...
    },
    {
      name: 'icon',
      type: 'IconType',
      description: 'Icon displayed in the outline (unselected) variant. See `npx khameleon docs icons` for valid semantic names.',
    },
    {
      name: 'selectedIcon',
      type: 'IconType',
      description: 'Icon displayed when the item is selected (filled variant). See `npx khameleon docs icons` for valid semantic names.',
    },
    {
      name: 'isSelected',
      type: 'boolean',
