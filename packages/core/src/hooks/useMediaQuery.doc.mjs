...
export const docs = {
  ...
  usage: {
    ...
    bestPractices: [
      ...
      { guidance: true, description: 'Prefer Khameleon responsive tokens and component props over manual breakpoint logic when possible.' },
...
export const docsDense = {
  ...
  usage: {
    ...
    bestPractices: [
      { guidance: true, description: 'Use for responsive layout switching based on viewport width, color scheme, or motion preferences.' },
      { guidance: true, description: 'Prefer Khameleon responsive tokens + component props over manual breakpoint logic when possible.' },
