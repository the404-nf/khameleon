...
export const docs = {
  ...
  usage: {
    description:
      'Returns a StyleX style for animating an element on mount. Only animates when the element is dynamically inserted after the initial page paint; elements rendered on page load are not animated. Uses Khameleon motion tokens (duration, easing) for consistent animation timing. Requires "use client"; does not support SSR.',
    bestPractices: [
...
export const docsDense = {
  description:
    'Returns StyleX style for animating element on mount. Only animates when element dynamically inserted after initial page paint; elements rendered on page load not animated. Uses Khameleon motion tokens (duration, easing) for consistent timing. Requires "use client"; does not support SSR.',
  paramDescriptions: {
