...
export const docs = {
  ...
  theming: {
    targets: [
      ...
      {className: 'khameleon-table'},
      {className: 'khameleon-table-scroll-wrapper'},
      {className: 'khameleon-table-header'},
      {className: 'khameleon-table-body'},
      {className: 'khameleon-table-footer'},
      {className: 'khameleon-table-row'},
      {className: 'khameleon-table-cell'},
      {className: 'khameleon-table-header-cell'},
    ],
  },
  ...
  props: [
    ...
    },
    {
      name: 'columns',
      type: 'TableColumn<T>[]',
      description: 'Column definitions: each column has {key, header, width?, align?, renderCell?}. The `header` field sets the column heading text. If omitted, columns are auto-generated from data object keys. The `width` field is typed as `ColumnWidth` (not a number); use `proportional(n)` or `pixel(n)` helpers imported from `@khameleon/core/Table`. Example: `width: pixel(120)` for 120px fixed, `width: proportional(1)` for flex distribution.',
    },
    {
      name: 'idKey',
  ...
  usage: {
    ...
    bestPractices: [
      ...
      { guidance: true, description: 'Compose rich cell content with Khameleon components like Badge, StatusDot, and Avatar via renderCell.' },
