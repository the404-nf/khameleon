 ...
 * @input React, types, Khameleon components, theme tokens
...
function TextFilterControl({
  ...
  return (
    <TextInput
      label={t('@khameleon.tableFiltering.filterByColumn', {header})}
      isLabelHidden
      value={strValue}
      ...
      placeholder={t('@khameleon.tableFiltering.filterByColumn', {header})}
      size={size}
      hasClear={hasClear}
    />
  );
  ...
  if (hasClear) {
    return (
      <Selector
        ...
        value={strValue || null}
        onChange={handleChange}
        placeholder={t('@khameleon.table.filter.allPlaceholder')}
        size={size}
        hasClear
      />
    );
...
function PopoverFilterTrigger({
  ...
  return (
    <Popover
        ...
        <FilterStoreContext value={draftStore}>
          <div {...stylex.props(filterStyles.popoverContent)}>
            ...
            <div {...stylex.props(filterStyles.popoverActions)}>
              <Button
                label={t('@khameleon.table.filter.reset')}
                variant="ghost"
                size="sm"
                onClick={handleClear}
              />
              ...
              <Button
                label={t('@khameleon.table.filter.apply')}
                variant="primary"
                size="sm"
                onClick={handleApply}
              />
      ...
      <button
        type="button"
        aria-label={t('@khameleon.tableFiltering.filterByColumn', {header})}
