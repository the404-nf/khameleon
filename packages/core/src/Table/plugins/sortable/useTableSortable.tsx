 ...
 *
 * Follows Khameleon headless plugin conventions: the consumer owns all state
...
const sortStyles = stylex.create({
  ...
  rank: {
    fontSize: 10,
    // eslint-disable-next-line @khameleon/no-hardcoded-styles -- no token for lineHeight:1 (tight badge)
    lineHeight: '1',
        ...
        const getSortActions = (): TableContextAction[] => {
          ...
          const actions: TableContextAction[] = [
            {
              id: 'sort-asc',
              group: 'sort',
              label: t('@khameleon.table.sort.ascending'),
            ...
            },
            {
              id: 'sort-desc',
              group: 'sort',
              label: t('@khameleon.table.sort.descending'),
          ...
          if (dir != null) {
            actions.push({
              id: 'sort-clear',
              group: 'sort-clear',
              label: t('@khameleon.table.sort.clear'),
