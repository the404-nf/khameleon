...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'khameleon-checkbox-input', visualProps: ['size']},
      {className: 'khameleon-checkbox', visualProps: ['size'], states: ['checked', 'disabled']},
    ],
  },
  usage: {
...
export const docsZh = {
  ...
  theming: {
    targets: [
      {
        className: 'khameleon-checkbox-input',
        visualProps: [
          'size',
        ],
      },
