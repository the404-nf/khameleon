...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'khameleon-radio-list', visualProps: ['orientation', 'size']},
      {className: 'khameleon-radio-list-item'},
      {className: 'khameleon-radio', visualProps: ['size'], states: ['checked', 'disabled']},
      {className: 'khameleon-radio-dot', visualProps: ['size']},
    ],
  },
