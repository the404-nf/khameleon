...
export function DateTimeInput({
  ...
  const placeholder =
    placeholderFromProps ?? t('@khameleon.dateTimeInput.placeholder');
  const timePlaceholder =
    timePlaceholderFromProps ?? t('@khameleon.dateTimeInput.timePlaceholder');
  ...
  const popover = usePopover({
    dialogLabel: t('@khameleon.dateTimeInput.dialogLabel'),
    closeButtonLabel: t('@khameleon.dateInput.closeCalendar'),
      ...
      <div
        ...
        <div
          ...
          <button
            ...
            aria-label={
              popover.isOpen
                ? t('@khameleon.dateInput.toggleCalendarClose')
                : t('@khameleon.dateInput.openCalendar')
            }
            {...stylex.props(
              styles.iconButton,
          ...
          */}
          ...
          {hasClear && value !== undefined && !isEffectivelyDisabled && (
            <button
              type="button"
              onClick={handleClear}
              aria-label={t('@khameleon.dateInput.clear', {label})}
        ...
        <div
          ...
          <input
            ...
            aria-disabled={showsDisabledMessage ? 'true' : undefined}
            readOnly={showsDisabledMessage || undefined}
            aria-label={timeLabel ?? t('@khameleon.dateTimeInput.timeSuffix', {label})}
            aria-describedby={ariaDescribedBy}
            aria-required={isRequired === true ? 'true' : undefined}
            aria-invalid={
