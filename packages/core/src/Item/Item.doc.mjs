...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'khameleon-item', visualProps: ['density', 'align']},
    ],
  },
  components: [
    {
  ...
  usage: {
    description:
      'A single, flexible item primitive that unifies the "start content + label + description + end content" pattern across Khameleon. Use it wherever you need a structured row: dropdown menus, selectors, contact lists, notifications, file browsers, and activity feeds.',
    bestPractices: [
...
export const docsZh = {
  ...
  usage: {
    description:
      '通用项目原语，统一 Khameleon 中 "起始内容 + 标签 + 描述 + 结束内容" 的布局模式。适用于下拉菜单、选择器、联系人列表、通知、文件浏览器和活动流等场景。',
    bestPractices: [
