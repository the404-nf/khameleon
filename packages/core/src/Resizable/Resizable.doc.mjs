...
export const docs = {
    ...
    bestPractices: [
      {
        guidance: true,
        description:
          'Use useResizable() with existing Khameleon layout components. ' +
  ...
  theming: {
    targets: [
      {className: 'khameleon-resize-handle', visualProps: ['direction']},
      {className: 'khameleon-resize-handle-pill'},
    ],
  },
  components: [
    {
...
export const docsDense = {
  ...
  usage: {
    ...
    bestPractices: [
      {guidance: true, description: 'Use useResizable() w/ existing Khameleon layout components. Pass returned props to resizable prop on LayoutPanel or SideNav.'},
