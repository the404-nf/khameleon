 ...
 * @example
 * ```
 * declare module '@khameleon/core/Banner' {
          ...
          <div
            ...
            {hasChildren && (
              <Button
                variant="ghost"
                size="sm"
                label={isExpanded ? t('@khameleon.banner.collapse') : t('@khameleon.banner.expand')}
                tooltip={isExpanded ? t('@khameleon.banner.collapse') : t('@khameleon.banner.expand')}
                icon={
                  <span
                    {...stylex.props(
                      styles.chevron,
            ...
            {isDismissable && (
              <Button
                variant="ghost"
                size="sm"
                label={t('@khameleon.banner.dismiss')}
                tooltip={t('@khameleon.banner.dismiss')}
