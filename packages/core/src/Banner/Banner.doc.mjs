...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'khameleon-banner', visualProps: ['container', 'status']},
      {className: 'khameleon-banner-icon', visualProps: ['status']},
      {className: 'khameleon-banner-content', visualProps: ['container', 'status']},
    ],
    vars: [
...
export const docsZh = {
  ...
  theming: {
    targets: [
      ...
      {
        className: 'khameleon-banner-icon',
        visualProps: [
          'status',
        ],
      },
      {
        className: 'khameleon-banner-content',
        visualProps: [
          'container',
          'status',
        ],
