...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'khameleon-app-shell', visualProps: ['variant']},
      {className: 'khameleon-app-shell-header', visualProps: ['variant']},
      {className: 'khameleon-app-shell-sidenav', visualProps: ['variant']},
    ],
  },
};
