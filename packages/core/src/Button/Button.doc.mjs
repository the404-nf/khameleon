...
export const docs = {
  ...
  usage: {
    ...
    bestPractices: [
      ...
      {guidance: true, description: 'For a dedicated icon-only button, use IconButton from \'@khameleon/core/IconButton\'. It is a separate component, not exported from \'@khameleon/core/Button\'.'},
  ...
  props: [
    ...
    },
    {
      ...
      type: 'boolean',
      description:
        'When true, renders as a square icon-only button with label as aria-label. Requires icon. Tip: for a dedicated icon-only button component, use IconButton from \'@khameleon/core/IconButton\' instead.',
      default: 'false',
    },
    {
      name: 'width',
  ...
  theming: {
    targets: [
      {className: 'khameleon-button', visualProps: ['size', 'variant']},
    ],
    vars: [
...
export const docsDense = {
  ...
  usage: {
    ...
    bestPractices: [
      ...
      {guidance: true, description: 'For dedicated icon-only buttons, use IconButton from @khameleon/core/IconButton. Separate component, not exported from @khameleon/core/Button.'},
