...
export function Selector<T extends SelectorOptionType>(
  ...
  const placeholder = placeholderFromProps ?? t('@khameleon.selector.placeholder');
  const searchPlaceholder =
    searchPlaceholderFromProps ?? t('@khameleon.selector.searchPlaceholder');
    ...
    return (
      <div {...stylex.props(styles.searchWrapper)}>
        <input
          ...
          aria-label={t('@khameleon.selector.searchOptions')}
          type="text"
          value={searchQuery}
      ...
      <div
        ...
        {hasClear && value != null && !isDisabled && (
          <button
            type="button"
            onClick={handleClear}
            aria-label={t('@khameleon.selector.clearLabel', {label})}
