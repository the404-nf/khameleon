...
const styles = stylex.create({
  ...
  scroller: {
    ...
    overflowX: 'auto',
    overflowY: 'hidden',
    /* eslint-disable @khameleon/no-hardcoded-styles -- 1px bleed for tab indicator; no token at this size */
    paddingBottom: '1px',
    marginBottom: '-1px',
    /* eslint-enable @khameleon/no-hardcoded-styles */
...
export function Carousel({
  ...
  const ariaLabel = ariaLabelFromProps ?? t('@khameleon.carousel.label');
          ...
          <>
            <div
              ...
              <Button
                ...
                label={t('@khameleon.carousel.scrollLeft')}
                variant="ghost"
                size="sm"
                isIconOnly
            ...
            <div
              ...
              <Button
                ...
                label={t('@khameleon.carousel.scrollRight')}
                variant="ghost"
                size="sm"
                isIconOnly
