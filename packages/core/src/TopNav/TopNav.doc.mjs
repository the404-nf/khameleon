...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'khameleon-top-nav', states: ['mode']},
      {className: 'khameleon-top-nav-item', states: ['mode', 'selected']},
      {className: 'khameleon-top-nav-heading'},
      {className: 'khameleon-top-nav-mega-menu', states: ['mode']},
      {className: 'khameleon-top-nav-mega-menu-item', states: ['mode']},
      {className: 'khameleon-top-nav-mega-menu-featured-card'},
      {className: 'khameleon-top-nav-menu'},
    ],
  },
