...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'khameleon-link', visualProps: ['color']},
    ],
  },
  components: [
    {
      ...
      ],    },
    {
      ...
      description:
        'Provider that sets the default link component for all Khameleon link-rendering components in the subtree. ' +
...
export const docsZh = {
  ...
  components: [
    ...
    },
    {
      ...
      displayName: 'Link Provider',
      description:
        '为子树中所有 Khameleon 链接组件设置默认链接组件的 Provider。',
      props: [
        {
          name: 'component',
          type: 'LinkComponentType',
...
export const docsDense = {
  ...
  components: [
    ...
    },
    {
      ...
      displayName: 'Link Provider',
      description:
        'Provider setting default link component for all Khameleon links in subtree.',
      propDescriptions: {
