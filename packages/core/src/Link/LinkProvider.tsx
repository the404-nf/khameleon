 ...
 *
 * Sets the default link component for all Khameleon components in the subtree.
...
/**
 * Provides a custom link component to all Khameleon components in the subtree.
 *
