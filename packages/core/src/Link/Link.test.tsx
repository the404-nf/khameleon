...
describe('Link', () => {
  ...
  it('defaults the inner text type to body', () => {
    ...
    expect(screen.getByText('Body link')).toHaveClass('khameleon-text', 'body');
  });
  ...
  it('forwards type="inherit" so the link adopts the surrounding text type', () => {
    ...
    expect(text).toHaveClass('khameleon-text', 'inherit');
  ...
  it('applies isDisabled state correctly', () => {
    ...
    expect(link?.className).toContain('khameleon-link');
  });
