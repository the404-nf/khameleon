  ...
  return (
    <HStack gap={2} vAlign="center">
      <div {...stylex.props(styles.nestedFieldSelector)}>
        <Selector
          label={t('@khameleon.powersearch.editor.field')}
          isLabelHidden
      ...
      {operatorOptions.length > 0 && (
        <div {...stylex.props(styles.nestedOperatorSelector)}>
          <Selector
            label={t('@khameleon.powersearch.editor.operator')}
            isLabelHidden
      ...
      if (isNested) {
        ...
        if (!isReadOnly) {
          children.push({
            ...
            label: (
              <Button
                label={t('@khameleon.powersearch.editor.addFilter')}
        ...
        return {
          ...
          endContent: !isReadOnly ? (
            <Button
              label={t('@khameleon.powersearch.editor.removeFilter')}
    ...
    <div {...stylex.props(styles.nestedRootLabel)}>
      {operatorOptions.length > 1 ? (
        <div {...stylex.props(styles.operatorSelector)}>
          <Selector
            label={t('@khameleon.powersearch.editor.groupOperator')}
            isLabelHidden
            options={operatorOptions}
        ...
        (operatorOptions[0]?.label ?? t('@khameleon.powersearch.editor.group'))
      )}
    </div>
  );
...
export function PowerSearchEditPopover({
  ...
  const saveButtonLabel =
    saveButtonLabelFromProps ?? t('@khameleon.powersearch.editor.apply');
        ...
        <div {...stylex.props(styles.footer)}>
          <HStack gap={2} hAlign="between">
            {!isReadOnly && mode === 'edit' ? (
              <Button
                label={t('@khameleon.powersearch.editor.delete')}
            ...
            <HStack gap={2}>
              <Button
                label={t('@khameleon.powersearch.editor.cancel')}
                onClick={onCancel}
                variant="ghost"
                size="sm"
              />
