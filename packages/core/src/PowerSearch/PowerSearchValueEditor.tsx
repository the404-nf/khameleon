...
function StringEditor({
  ...
  if (operatorValue.searchSource) {
    ...
    return (
      <Typeahead
        label={t('@khameleon.powersearch.valueEditor.value')}
        isLabelHidden
        ...
        placeholder={t('@khameleon.powersearch.valueEditor.searchPlaceholder')}
        debounceMs={150}
      />
    );
  }
  ...
  return (
    <TextInput
      ...
      isLabelHidden
      value={currentValue}
      placeholder={t('@khameleon.powersearch.valueEditor.enterValuePlaceholder')}
...
function StringListEditor({
  ...
  return (
    <Tokenizer
      label={t('@khameleon.powersearch.valueEditor.values')}
      isLabelHidden
      searchSource={source}
      value={currentValue}
      onChange={items => {
      ...
      placeholder={t('@khameleon.powersearch.valueEditor.addValuesPlaceholder')}
...
function IntegerEditor({
  ...
  return (
    <NumberInput
      ...
      isIntegerOnly
      placeholder={t('@khameleon.powersearch.valueEditor.enterNumberPlaceholder')}
    />
  );
}
...
function TimeEditor({
  ...
  return (
    <TimeInput
      label={t('@khameleon.powersearch.valueEditor.time')}
      isLabelHidden
      value={currentValue}
      onChange={value => {
        if (value != null) {
...
function DateAbsoluteEditor({
  ...
  return (
    <DateInput
      label={t('@khameleon.powersearch.valueEditor.date')}
      isLabelHidden
      value={currentValue}
      onChange={value => {
        if (value != null) {
...
function DateRelativeEditor({
  ...
  return (
    <Selector
      label={t('@khameleon.powersearch.valueEditor.relativeDate')}
      isLabelHidden
      options={options}
      value={currentValue}
      onChange={value => {
...
function DateRangeEditor({
  ...
  return (
    <>
      <DateInput
        label={t('@khameleon.powersearch.valueEditor.startDate')}
        isLabelHidden
        value={startValue}
        onChange={handleStartChange}
      />
      <DateInput
        label={t('@khameleon.powersearch.valueEditor.endDate')}
        isLabelHidden
        value={endValue}
...
function EnumListEditor({
  ...
  return (
    <Tokenizer
      ...
      placeholder={t('@khameleon.powersearch.valueEditor.selectValuesPlaceholder')}
      hasEntriesOnFocus
      debounceMs={0}
    />
  );
...
function EntityListEditor({
  ...
  return (
    <Tokenizer
      label={t('@khameleon.powersearch.valueEditor.entities')}
      isLabelHidden
      searchSource={source}
      value={currentValue}
      onChange={items => {
