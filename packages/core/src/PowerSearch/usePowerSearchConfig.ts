    ...
    operators: [
      {
        ...
        i18nKey: '@khameleon.powersearch.operator.contains',
        value: {type: 'string'},
      },
      {
        key: StringOps.NOT_CONTAINS,
        i18nKey: '@khameleon.powersearch.operator.notContains',
        value: {type: 'string'},
      },
      {
        key: StringOps.STARTS_WITH,
        i18nKey: '@khameleon.powersearch.operator.startsWith',
        value: {type: 'string'},
      },
      {
        key: StringOps.NOT_STARTS_WITH,
        i18nKey: '@khameleon.powersearch.operator.notStartsWith',
        value: {type: 'string'},
      },
      {
        key: StringOps.ENDS_WITH,
        i18nKey: '@khameleon.powersearch.operator.endsWith',
        value: {type: 'string'},
      },
      {
        key: StringOps.NOT_ENDS_WITH,
        i18nKey: '@khameleon.powersearch.operator.notEndsWith',
        value: {type: 'string'},
      },
      {
        key: StringOps.IS,
        i18nKey: '@khameleon.powersearch.operator.is',
        value: {type: 'string'},
      },
      {
        key: StringOps.IS_NOT,
        i18nKey: '@khameleon.powersearch.operator.isNot',
        value: {type: 'string'},
      },
    ],
  };
    ...
    operators: [
      {
        ...
        i18nKey: '@khameleon.powersearch.operator.equals',
        value: {type: 'float'},
      },
      {
        key: NumberOps.NOT_EQUALS,
        i18nKey: '@khameleon.powersearch.operator.notEquals',
        value: {type: 'float'},
      },
      {
        key: NumberOps.GREATER_THAN,
        i18nKey: '@khameleon.powersearch.operator.greaterThan',
        value: {type: 'float'},
      },
      {
        key: NumberOps.LESS_THAN,
        i18nKey: '@khameleon.powersearch.operator.lessThan',
        value: {type: 'float'},
      },
      {
        key: NumberOps.GREATER_THAN_OR_EQUAL,
        i18nKey: '@khameleon.powersearch.operator.greaterThanOrEqual',
        value: {type: 'float'},
      },
      {
        key: NumberOps.LESS_THAN_OR_EQUAL,
        i18nKey: '@khameleon.powersearch.operator.lessThanOrEqual',
        value: {type: 'float'},
      },
    ],
  };
...
function dateOperators(): {
  ...
  return {
    ...
    operators: [
      {
        key: DateOps.BEFORE,
        i18nKey: '@khameleon.powersearch.operator.before',
        value: {type: 'date_absolute'},
      },
      {
        key: DateOps.AFTER,
        i18nKey: '@khameleon.powersearch.operator.after',
        value: {type: 'date_absolute'},
      },
      {
        key: DateOps.BETWEEN,
        i18nKey: '@khameleon.powersearch.operator.between',
    ...
    operators: [
      {
        ...
        i18nKey: '@khameleon.powersearch.operator.isTrue',
        value: {type: 'empty'},
      },
      {
        key: BooleanOps.IS_FALSE,
        i18nKey: '@khameleon.powersearch.operator.isFalse',
        value: {type: 'empty'},
      },
    ],
  };
  ...
  return {
    ...
    operators: [
      ...
      },
      {
        ...
        i18nKey: '@khameleon.powersearch.operator.isAnyOf',
        value: {type: 'enum_list', values},
      },
      {
        key: EnumListOps.IS_NONE_OF,
        i18nKey: '@khameleon.powersearch.operator.isNoneOf',
        value: {type: 'enum_list', values},
      },
    ],
  };
