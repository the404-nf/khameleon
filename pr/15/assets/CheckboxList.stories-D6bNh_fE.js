import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./react-BZJXY1be.js";import{t as n}from"./jsx-runtime-DeHZSEgm.js";import{n as r,t as i}from"./Card-CEKem3UW.js";import{n as a,t as o}from"./List-D9mBAsPV.js";import{i as s,n as c,r as l,t as u}from"./CheckboxListItem-nfch5R-_.js";var d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A;function j(){return(j=e((()=>{d=t(),s(),c(),a(),r(),f=n(),p={title:`Core/CheckboxList`,component:l,tags:[`autodocs`],argTypes:{label:{control:`text`,description:`Label text (required)`},isLabelHidden:{control:`boolean`,description:`Visually hide the label (still accessible to screen readers)`},description:{control:`text`,description:`Description text displayed below the label`},density:{control:`select`,options:[`compact`,`balanced`,`spacious`],description:`Spacing density for list items`},hasDividers:{control:`boolean`,description:`Whether to show dividers between items`},isDisabled:{control:`boolean`,description:`Whether all checkbox items are disabled`},disabledMessage:{control:`text`,description:`Explains why the group is disabled (whole-group state, not per item). With isDisabled, shows a tooltip on hover/keyboard focus and keeps the checkboxes focusable via aria-disabled (toggling stays blocked). Use this instead of wrapping a disabled CheckboxList in Tooltip.`}}},m={render:e=>{let[t,n]=(0,d.useState)(e.value??[]),{value:r,onChange:i,...a}=e;return(0,f.jsxs)(l,{...a,value:t,onChange:n,children:[(0,f.jsx)(u,{label:`Email`,value:`email`}),(0,f.jsx)(u,{label:`SMS`,value:`sms`}),(0,f.jsx)(u,{label:`Push notification`,value:`push`})]})},args:{label:`Notification preferences`}},h={render:e=>{let[t,n]=(0,d.useState)(e.value??[]),{value:r,onChange:i,...a}=e;return(0,f.jsxs)(l,{...a,value:t,onChange:n,children:[(0,f.jsx)(u,{label:`Email`,value:`email`,description:`Receive notifications via email`}),(0,f.jsx)(u,{label:`SMS`,value:`sms`,description:`Standard messaging rates apply`}),(0,f.jsx)(u,{label:`Push notification`,value:`push`,description:`Instant alerts on your device`})]})},args:{label:`Notification preferences`,description:`Choose how you would like to be notified`,hasDividers:!0}},g={render:e=>{let t=[{id:`react`,label:`React`},{id:`vue`,label:`Vue`},{id:`angular`,label:`Angular`},{id:`svelte`,label:`Svelte`}],[n,r]=(0,d.useState)([`react`]),{value:i,onChange:a,...o}=e;return(0,f.jsx)(l,{...o,value:n,onChange:r,children:t.map(e=>(0,f.jsx)(u,{label:e.label,value:e.id},e.id))})},args:{label:`Frameworks`}},_={render:()=>{let[e,t]=(0,d.useState)(!1),[n,r]=(0,d.useState)(!0),[i,a]=(0,d.useState)(!1);return(0,f.jsxs)(o,{children:[(0,f.jsx)(u,{label:`Accept terms and conditions`,isChecked:e,onCheck:t}),(0,f.jsx)(u,{label:`Subscribe to newsletter`,description:`Weekly updates about new features`,isChecked:n,onCheck:r}),(0,f.jsx)(u,{label:`Receive marketing emails`,isChecked:i,onCheck:a})]})}},v={render:()=>(0,f.jsxs)(o,{children:[(0,f.jsx)(u,{label:`Completed task`,isChecked:!0}),(0,f.jsx)(u,{label:`Pending task`,isChecked:!1}),(0,f.jsx)(u,{label:`In progress`,isChecked:`indeterminate`})]})},y={render:()=>{let e=[`email`,`sms`,`push`],[t,n]=(0,d.useState)([`email`]),r=e.every(e=>t.includes(e)),i=t.length===0,a=r?!0:!i&&`indeterminate`;return(0,f.jsxs)(l,{label:`Notifications`,hasDividers:!0,children:[(0,f.jsx)(u,{label:`Select all`,isChecked:a,onCheck:t=>{n(t?[...e]:[])}}),e.map(e=>(0,f.jsx)(u,{label:e.charAt(0).toUpperCase()+e.slice(1),isChecked:t.includes(e),onCheck:t=>{n(n=>t?[...n,e]:n.filter(t=>t!==e))}},e))]})}},b={render:e=>{let[t,n]=(0,d.useState)([`email`]),{value:r,onChange:i,...a}=e;return(0,f.jsxs)(l,{...a,value:t,onChange:n,children:[(0,f.jsx)(u,{label:`Email`,value:`email`}),(0,f.jsx)(u,{label:`SMS`,value:`sms`}),(0,f.jsx)(u,{label:`Push notification`,value:`push`})]})},args:{label:`Notification preferences`,isDisabled:!0}},x={render:()=>{let[e,t]=(0,d.useState)([`email`]);return(0,f.jsxs)(l,{label:`Notification preferences`,value:e,onChange:t,children:[(0,f.jsx)(u,{label:`Email`,value:`email`}),(0,f.jsx)(u,{label:`SMS`,value:`sms`,isLoading:!0}),(0,f.jsx)(u,{label:`Push notification`,value:`push`})]})}},S={render:()=>{let[e,t]=(0,d.useState)([`email`]);return(0,f.jsxs)(l,{label:`Notification preferences`,description:`Toggle an option — it spins while saving`,value:e,changeAction:e=>new Promise(n=>{setTimeout(()=>{t(e),n()},1500)}),hasDividers:!0,children:[(0,f.jsx)(u,{label:`Email`,value:`email`}),(0,f.jsx)(u,{label:`SMS`,value:`sms`}),(0,f.jsx)(u,{label:`Push notification`,value:`push`})]})}},C={render:e=>{let[t,n]=(0,d.useState)([]),{value:r,onChange:i,...a}=e;return(0,f.jsxs)(l,{...a,value:t,onChange:n,children:[(0,f.jsx)(u,{label:`Email`,value:`email`}),(0,f.jsx)(u,{label:`SMS`,value:`sms`,isDisabled:!0}),(0,f.jsx)(u,{label:`Push notification`,value:`push`})]})},args:{label:`Notification preferences`}},w={render:e=>{let[t,n]=(0,d.useState)([]),{value:r,onChange:i,...a}=e;return(0,f.jsxs)(l,{...a,value:t,onChange:n,children:[(0,f.jsx)(u,{label:`Email`,value:`email`}),(0,f.jsx)(u,{label:`SMS`,value:`sms`}),(0,f.jsx)(u,{label:`Push notification`,value:`push`})]})},args:{label:`Notification preferences`,status:{type:`error`,message:`Please select at least one notification method`}}},T={render:e=>{let[t,n]=(0,d.useState)([`free`]),{value:r,onChange:i,...a}=e;return(0,f.jsxs)(l,{...a,value:t,onChange:n,children:[(0,f.jsx)(u,{label:`Free tier`,value:`free`,description:`Basic features included`,endContent:(0,f.jsx)(`span`,{style:{color:`#0D8626`},children:`$0/mo`})}),(0,f.jsx)(u,{label:`Pro tier`,value:`pro`,description:`Advanced features`,endContent:(0,f.jsx)(`span`,{style:{color:`#0064E0`},children:`$9/mo`})}),(0,f.jsx)(u,{label:`Enterprise`,value:`enterprise`,description:`Custom solutions`,endContent:(0,f.jsx)(`span`,{style:{color:`#5B08D8`},children:`Custom`})})]})},args:{label:`Add-on packages`,hasDividers:!0}},E={render:()=>{let[e,t]=(0,d.useState)([]),[n,r]=(0,d.useState)([`email`]),[i,a]=(0,d.useState)(!1),[s,c]=(0,d.useState)(!0);return(0,f.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`24px`,maxWidth:`400px`},children:[(0,f.jsxs)(l,{label:`Unselected`,value:e,onChange:t,children:[(0,f.jsx)(u,{label:`Option A`,value:`a`}),(0,f.jsx)(u,{label:`Option B`,value:`b`})]}),(0,f.jsxs)(l,{label:`Pre-selected`,value:n,onChange:r,children:[(0,f.jsx)(u,{label:`Email`,value:`email`}),(0,f.jsx)(u,{label:`SMS`,value:`sms`})]}),(0,f.jsxs)(l,{label:`Disabled group`,value:[`a`],onChange:()=>{},isDisabled:!0,children:[(0,f.jsx)(u,{label:`Option A`,value:`a`}),(0,f.jsx)(u,{label:`Option B`,value:`b`})]}),(0,f.jsxs)(l,{label:`With descriptions`,value:e,onChange:t,hasDividers:!0,children:[(0,f.jsx)(u,{label:`Email`,value:`email`,description:`Delivered to your inbox`}),(0,f.jsx)(u,{label:`SMS`,value:`sms`,description:`Standard rates apply`})]}),(0,f.jsxs)(l,{label:`With error`,value:[],onChange:()=>{},status:{type:`error`,message:`Please select at least one option`},children:[(0,f.jsx)(u,{label:`Option A`,value:`a`}),(0,f.jsx)(u,{label:`Option B`,value:`b`})]}),(0,f.jsxs)(`div`,{children:[(0,f.jsx)(`h4`,{style:{margin:`0 0 8px`},children:`Standalone mode`}),(0,f.jsxs)(o,{children:[(0,f.jsx)(u,{label:`Accept terms`,isChecked:i,onCheck:a}),(0,f.jsx)(u,{label:`Subscribe`,isChecked:s,onCheck:c})]})]})]})}},D={render(){let[e,t]=(0,d.useState)([`email`]);return(0,f.jsx)(`div`,{style:{maxWidth:400},children:(0,f.jsx)(i,{children:(0,f.jsxs)(l,{label:`Notifications`,description:`Choose how to be notified`,value:e,onChange:t,children:[(0,f.jsx)(u,{value:`email`,label:`Email`,description:`Weekly digest`}),(0,f.jsx)(u,{value:`push`,label:`Push notifications`}),(0,f.jsx)(u,{value:`sms`,label:`SMS`,isDisabled:!0})]})})})}},O={render(){let[e,t]=(0,d.useState)([`admin`]);return(0,f.jsx)(`div`,{style:{maxWidth:400},children:(0,f.jsx)(i,{children:(0,f.jsxs)(l,{label:`Assign Roles`,value:e,onChange:t,hasDividers:!0,children:[(0,f.jsx)(u,{value:`admin`,label:`Admin`}),(0,f.jsx)(u,{value:`editor`,label:`Editor`}),(0,f.jsx)(u,{value:`viewer`,label:`Viewer`}),(0,f.jsx)(u,{value:`guest`,label:`Guest`})]})})})}},k={render:e=>{let[t,n]=(0,d.useState)([`email`]),{value:r,onChange:i,...a}=e;return(0,f.jsxs)(l,{...a,value:t,onChange:n,children:[(0,f.jsx)(u,{label:`Email`,value:`email`}),(0,f.jsx)(u,{label:`SMS`,value:`sms`}),(0,f.jsx)(u,{label:`Push notification`,value:`push`})]})},args:{label:`Notification preferences`,isDisabled:!0,disabledMessage:`Notifications are managed by your administrator`}},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  render: args => {
