...
echo "Deploy complete: $VERSION"`,language:`bash`,title:`deploy.sh`,hasLineNumbers:!0}},f={args:{code:`npm install @khameleon/core`,language:`bash`,hasCopyButton:!0}},p={args:{code:`// This is a very long line that demonstrates the word wrapping behavior of the code block component when isWrapped is set to true, which causes long lines to wrap instead of scrolling horizontally
...
}`,...y.parameters?.docs?.source}}},b=[`Default`,`WithHighlightedLines`,`JSON`,`Python`,`HTML`,`CSS`,`Bash`,`SingleLine`,`Wrapped`,`WithMaxHeight`,`SmallSize`,`NoHeader`,`Plaintext`,`FullWidth`,`ContainerSection`]})))()}x();export{d as Bash,u as CSS,y as ContainerSection,a as Default,v as FullWidth,l as HTML,s as JSON,g as NoHeader,_ as Plaintext,c as Python,f as SingleLine,h as SmallSize,o as WithHighlightedLines,m as WithMaxHeight,p as Wrapped,b as __namedExportsOrder,r as default};