import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{d as n,f as r,g as i,h as a,i as o,m as s,p as c,r as l,s as u}from"./_data-CkI161uB.js";import{n as d,t as f}from"./bar-CK4ZDenf.js";import{n as p,t as m}from"./line-MFJPp38y.js";import{n as h,t as g}from"./band-BOIzviha.js";import{n as _,t as v}from"./errorBar-DCOnQKf7.js";import{n as y,t as b}from"./referenceLine-CxNYnXAL.js";var x,S,C,w,T,E;function D(){return(D=e((()=>{i(),d(),m(),h(),_(),b(),r(),s(),l(),x=t(),S={title:`Charts/Composite`,component:a},C=(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(c,{position:`bottom`}),(0,x.jsx)(c,{position:`left`})]}),w={render:()=>(0,x.jsx)(a,{data:o,xKey:`month`,title:`Revenue vs trend`,subtitle:`Bars with a trendline overlay`,series:[f(`revenue`,{color:`#3b82f6`,label:`Revenue`}),p(`trend`,{color:`#f59e0b`,label:`Trend`})],tooltip:!0,legend:!0,grid:(0,x.jsx)(n,{}),axes:C,height:320})},T={render:()=>{let e=u.map((e,t,n)=>{let r=n.slice(0,t+1).reduce((e,t)=>e+t.sales,0)/(t+1);return{...e,runAvg:Math.round(r*10)/10,upper:Math.round((r+8)*10)/10,lower:Math.round((r-8)*10)/10}});return(0,x.jsx)(a,{data:e,xKey:`month`,title:`Kitchen sink`,series:[y({y:40,y2:60,color:`#22c55e`,bandOpacity:.08}),y({y:50,label:`Target`,color:`#ef4444`}),g({upper:`upper`,lower:`lower`,color:`#f59e0b`,opacity:.15}),f(`sales`,{color:`#3b82f6`,label:`Sales`}),v({high:`errorHigh`,low:`errorLow`,color:`#1e3a5f`}),p(`runAvg`,{color:`#f59e0b`,strokeWidth:2,label:`Run avg`})],grid:(0,x.jsx)(n,{}),axes:C,height:400})}},w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`{
