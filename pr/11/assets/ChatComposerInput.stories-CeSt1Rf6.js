import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./react-BZJXY1be.js";import{a as n,n as r,o as i,t as a}from"./ChatComposer-DkTTI62k.js";import{t as o}from"./jsx-runtime-DeHZSEgm.js";import{n as s,t as c}from"./Badge-DN3od1Tr.js";import{n as l,t as u}from"./TypeaheadItem-C0f9IIMh.js";import{t as d}from"./createStaticSource-Cfz9LMai.js";var f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P;function F(){return(F=e((()=>{r(),i(),s(),l(),f=t(),p=o(),m={title:`Core/ChatComposerInput`,component:n,tags:[`autodocs`],parameters:{layout:`centered`},decorators:[e=>(0,p.jsx)(`div`,{style:{width:600,padding:40},children:(0,p.jsx)(e,{})})]},h=[{id:`cindy`,label:`Cindy Zhang`,auxiliaryData:{role:`Design Systems`}},{id:`alex`,label:`Alex Johnson`,auxiliaryData:{role:`Frontend`}},{id:`sam`,label:`Sam Rivera`,auxiliaryData:{role:`Backend`}},{id:`jordan`,label:`Jordan Lee`,auxiliaryData:{role:`Product`}},{id:`taylor`,label:`Taylor Kim`,auxiliaryData:{role:`Design`}},{id:`morgan`,label:`Morgan Chen`,auxiliaryData:{role:`Infrastructure`}}],g=[{id:`summarize`,label:`summarize`,auxiliaryData:{description:`Summarize the conversation`}},{id:`translate`,label:`translate`,auxiliaryData:{description:`Translate text to another language`}},{id:`search`,label:`search`,auxiliaryData:{description:`Search the web or documents`}},{id:`code`,label:`code`,auxiliaryData:{description:`Generate or explain code`}},{id:`help`,label:`help`,auxiliaryData:{description:`Show available commands`}}],_=d(h),v=d(g),y={search(e){return new Promise(t=>{setTimeout(()=>{let n=e.toLowerCase();t(h.filter(e=>e.label.toLowerCase().includes(n)))},300)})},bootstrap(){return h}},b={render:()=>{let[e,t]=(0,f.useState)(``);return(0,p.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:12},children:[(0,p.jsx)(a,{onSubmit:e=>{alert(`Submitted: ${e}`),t(``)},value:e,onChange:t,input:(0,p.jsx)(n,{value:e,onChange:t,placeholder:`Type a message...`})}),(0,p.jsxs)(`div`,{style:{fontSize:12,fontFamily:`monospace`,color:`#888`},children:[`Value: `,JSON.stringify(e)]})]})}},x={render:()=>(0,p.jsx)(a,{onSubmit:e=>alert(e),input:(0,p.jsx)(n,{placeholder:`Ask me anything about Khameleon...`})})},S={render:()=>(0,p.jsx)(a,{onSubmit:()=>{},isDisabled:!0,input:(0,p.jsx)(n,{isDisabled:!0,placeholder:`Input is disabled`})})},C={render:()=>(0,p.jsx)(a,{onSubmit:e=>alert(e),input:(0,p.jsx)(n,{maxRows:3,placeholder:`Type a long message — scrolls after 3 lines...`})})},w={render:()=>{let[e,t]=(0,f.useState)([]);return(0,p.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:12},children:[(0,p.jsx)(a,{onSubmit:e=>t(t=>[...t,e]),input:(0,p.jsx)(n,{placeholder:`Submit messages, then ArrowUp to recall...`})}),e.length>0&&(0,p.jsx)(`div`,{style:{fontSize:12,fontFamily:`monospace`,color:`#666`},children:e.map((e,t)=>(0,p.jsxs)(`div`,{children:[`→ `,e]},t))})]})}},T={render:()=>{let[e,t]=(0,f.useState)([]);return(0,p.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:12},children:[(0,p.jsx)(a,{onSubmit:e=>alert(e),input:(0,p.jsx)(n,{onFiles:e=>t(t=>[...t,...e.map(e=>e.name)]),placeholder:`Paste files here (Ctrl+V)...`})}),e.length>0&&(0,p.jsxs)(`div`,{style:{fontSize:12,color:`#666`},children:[`Files: `,e.join(`, `)]})]})}},E={render:()=>{let[e,t]=(0,f.useState)(``),[r,i]=(0,f.useState)([]);return(0,p.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:16},children:[(0,p.jsx)(a,{onSubmit:e=>{i(t=>[...t,e]),t(``)},input:(0,p.jsx)(n,{value:e,onChange:t,triggers:[{character:`@`,searchSource:_,renderItem:e=>(0,p.jsx)(u,{item:e,description:e.auxiliaryData?.role}),onSelect:e=>({value:`@${e.id}`,label:e.label,variant:`blue`})}],placeholder:`Type @ to mention someone...`})}),(0,p.jsxs)(`div`,{style:{fontSize:12,fontFamily:`monospace`,color:`#888`},children:[`Value: `,JSON.stringify(e)]}),r.length>0&&(0,p.jsx)(`div`,{style:{fontSize:12,fontFamily:`monospace`,color:`#666`},children:r.map((e,t)=>(0,p.jsxs)(`div`,{children:[`→ `,e]},t))})]})}},D={render:()=>(0,p.jsx)(a,{onSubmit:e=>alert(`Sent: ${e}`),input:(0,p.jsx)(n,{triggers:[{character:`/`,searchSource:v,renderItem:e=>(0,p.jsx)(u,{item:e,description:e.auxiliaryData?.description}),onSelect:e=>({value:`/${e.label}`,label:`/${e.label}`,variant:`yellow`})}],placeholder:`Type / for commands...`})})},O={render:()=>(0,p.jsx)(a,{onSubmit:e=>alert(`Sent: ${e}`),input:(0,p.jsx)(n,{triggers:[{character:`@`,searchSource:y,onSelect:e=>({value:`@${e.id}`,label:e.label,variant:`blue`}),loadingText:`Searching users…`,emptySearchResultsText:`No users found`}],placeholder:`Type @ for async user search (300ms delay)...`})})},k={render:()=>{let[e,t]=(0,f.useState)(``);return(0,p.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:12},children:[(0,p.jsx)(a,{onSubmit:e=>{alert(`Sent: ${e}`),t(``)},input:(0,p.jsx)(n,{value:e,onChange:t,triggers:[{character:`@`,searchSource:_,onSelect:e=>({value:`@${e.id}`,label:e.label,variant:`blue`})},{character:`/`,searchSource:v,onSelect:e=>({value:`/${e.label}`,label:`/${e.label}`,variant:`yellow`})}],placeholder:`Type @ or / ...`})}),(0,p.jsxs)(`div`,{style:{fontSize:12,fontFamily:`monospace`,color:`#888`},children:[`Value: `,JSON.stringify(e)]})]})}},A={render:()=>(0,p.jsx)(a,{onSubmit:e=>alert(`Sent: ${e}`),input:(0,p.jsx)(n,{triggers:[{character:`@`,searchSource:_,renderItem:e=>(0,p.jsx)(u,{item:e,description:e.auxiliaryData?.role,icon:(0,p.jsx)(`div`,{style:{width:24,height:24,borderRadius:`50%`,backgroundColor:`#e8d5f5`,display:`flex`,alignItems:`center`,justifyContent:`center`,fontSize:11,fontWeight:600,color:`#7c3aed`},children:e.label.charAt(0)})}),onSelect:e=>({value:`@${e.id}`,label:e.label,variant:`purple`,icon:(0,p.jsx)(`span`,{style:{width:14,height:14,borderRadius:`50%`,backgroundColor:`#e8d5f5`,display:`inline-flex`,alignItems:`center`,justifyContent:`center`,fontSize:8,fontWeight:700,color:`#7c3aed`},children:e.label.charAt(0)})})}],placeholder:`Type @ — tokens have icons via badge config...`})})},j={render:()=>(0,p.jsx)(a,{onSubmit:e=>alert(`Sent: ${e}`),input:(0,p.jsx)(n,{triggers:[{character:`@`,searchSource:_,onSelect:e=>({value:`@${e.id}`,label:e.label,variant:`blue`})},{character:`/`,searchSource:v,onSelect:e=>({value:`/${e.label}`,label:`/${e.label}`,variant:`purple`})}],placeholder:`@ for blue mentions, / for purple commands...`})})},M={render:()=>(0,p.jsx)(a,{onSubmit:e=>alert(`Sent: ${e}`),input:(0,p.jsx)(n,{triggers:[{character:`@`,searchSource:_,renderItem:e=>(0,p.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:8},children:[(0,p.jsx)(`div`,{style:{width:24,height:24,borderRadius:`50%`,backgroundColor:`#e0e0e0`,display:`flex`,alignItems:`center`,justifyContent:`center`,fontSize:11,fontWeight:600},children:e.label.charAt(0)}),(0,p.jsx)(`span`,{children:e.label})]}),onSelect:e=>({value:`@${e.id}`,render:()=>(0,p.jsx)(`span`,{title:`Click to view ${e.label}'s profile`,style:{cursor:`pointer`},onClick:()=>alert(`Profile: ${e.label}`),children:(0,p.jsx)(c,{variant:`blue`,label:e.label,icon:(0,p.jsx)(`span`,{style:{width:14,height:14,borderRadius:`50%`,backgroundColor:`#c4d4f0`,display:`inline-flex`,alignItems:`center`,justifyContent:`center`,fontSize:8,fontWeight:700},children:e.label.charAt(0)})})})})}],placeholder:`Type @ — tokens are clickable with avatars...`})})},N={render:()=>{let e={character:`@`,searchSource:d([{id:`cindy`,label:`Cindy Zhang`,auxiliaryData:{group:`Design`,role:`Design Systems`}},{id:`taylor`,label:`Taylor Kim`,auxiliaryData:{group:`Design`,role:`Product Design`}},{id:`alex`,label:`Alex Johnson`,auxiliaryData:{group:`Engineering`,role:`Frontend`}},{id:`sam`,label:`Sam Rivera`,auxiliaryData:{group:`Engineering`,role:`Backend`}},{id:`morgan`,label:`Morgan Chen`,auxiliaryData:{group:`Engineering`,role:`Infrastructure`}},{id:`jordan`,label:`Jordan Lee`,auxiliaryData:{group:`Product`,role:`Product Manager`}}]),renderItem:e=>(0,p.jsx)(u,{item:e,description:e.auxiliaryData?.role}),onSelect:e=>({value:`@${e.id}`,label:e.label,variant:`blue`})};return(0,p.jsx)(a,{onSubmit:e=>alert(`Sent: ${e}`),input:(0,p.jsx)(n,{triggers:[e],placeholder:`Type @ to see grouped mentions...`})})}},b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  render: () => {
  ...
  render: () => <ChatComposer onSubmit={v => alert(v)} input={<ChatComposerInput placeholder="Ask me anything about Khameleon..." />} />
