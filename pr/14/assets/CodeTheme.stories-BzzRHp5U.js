import{i as e}from"./preload-helper-CT_b8DTk.js";import{t}from"./react-B7Te67-h.js";import{t as n}from"./jsx-runtime-DqZldVDK.js";import{o as r}from"./useTheme-CFxnJz0i.js";import{_ as i,a,c as o,d as s,f as c,g as l,h as u,i as d,m as f,n as p,o as m,p as h,r as g,s as _,t as v,u as y,x as b,y as x}from"./theme-C65lM0CV.js";import{i as S,t as C}from"./CodeBlock-DEPgK9AG.js";var w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K;e((()=>{t(),C(),p(),v(),w=n(),T=[`import {useState, useEffect} from 'react';`,``,`interface User {`,`  id: string;`,`  name: string;`,`  roles: string[];`,`}`,``,`const API_URL = "https://api.example.com";`,`const MAX_RETRIES = 3;`,``,`// Fetch user data with retry logic`,`async function fetchUser(id: string): Promise<User> {`,"  const response = await fetch(`${API_URL}/users/${id}`);",`  if (!response.ok) {`,"    throw new Error(`HTTP ${response.status}`);",`  }`,`  return response.json();`,`}`,``,`export function UserCard({id}: {id: string}) {`,`  const [user, setUser] = useState<User | null>(null);`,``,`  useEffect(() => {`,`    fetchUser(id).then(setUser);`,`  }, [id]);`,``,`  if (!user) return <div>Loading...</div>;`,``,`  return (`,`    <div className="card">`,`      <h2>{user.name}</h2>`,`      <span>{user.roles.length} roles</span>`,`    </div>`,`  );`,`}`].join(`
`),E={title:`Core/CodeTheme`,tags:[`autodocs`],parameters:{docs:{description:{component:`Syntax theme provider for code components. Wraps CodeBlock and CodeEditor to apply community syntax color themes. 12 presets ship in @khameleon/core/theme/syntax.`}}}},D={render:()=>(0,w.jsx)(i,{theme:c,children:(0,w.jsx)(S,{code:T,language:`typescript`,title:`UserCard.tsx`,hasLineNumbers:!0})})},O={render:()=>(0,w.jsx)(i,{theme:m,children:(0,w.jsx)(S,{code:T,language:`typescript`,title:`UserCard.tsx`,hasLineNumbers:!0})})},k={render:()=>(0,w.jsx)(i,{theme:y,children:(0,w.jsx)(S,{code:T,language:`typescript`,title:`UserCard.tsx`,hasLineNumbers:!0})})},A={render:()=>(0,w.jsx)(i,{theme:s,children:(0,w.jsx)(S,{code:T,language:`typescript`,title:`UserCard.tsx`,hasLineNumbers:!0})})},j={render:()=>(0,w.jsx)(i,{theme:u,children:(0,w.jsx)(S,{code:T,language:`typescript`,title:`UserCard.tsx`,hasLineNumbers:!0})})},M={render:()=>(0,w.jsx)(i,{theme:a,children:(0,w.jsx)(S,{code:T,language:`typescript`,title:`UserCard.tsx`,hasLineNumbers:!0})})},N={render:()=>(0,w.jsx)(i,{theme:o,children:(0,w.jsx)(S,{code:T,language:`typescript`,title:`UserCard.tsx`,hasLineNumbers:!0})})},P={render:()=>(0,w.jsx)(i,{theme:_,children:(0,w.jsx)(S,{code:T,language:`typescript`,title:`UserCard.tsx`,hasLineNumbers:!0})})},F={render:()=>(0,w.jsx)(i,{theme:f,children:(0,w.jsx)(S,{code:T,language:`typescript`,title:`UserCard.tsx`,hasLineNumbers:!0})})},I={render:()=>(0,w.jsx)(i,{theme:h,children:(0,w.jsx)(S,{code:T,language:`typescript`,title:`UserCard.tsx`,hasLineNumbers:!0})})},L={render:()=>(0,w.jsx)(i,{theme:d,children:(0,w.jsx)(S,{code:T,language:`typescript`,title:`UserCard.tsx`,hasLineNumbers:!0})})},R={render:()=>(0,w.jsx)(i,{theme:l,children:(0,w.jsx)(S,{code:T,language:`typescript`,title:`UserCard.tsx`,hasLineNumbers:!0})})},z=[`const greet = (name: string) => {`,`  // Say hello`,"  return `Hello, ${name}!`;",`};`,``,`const result = greet("World");`,`console.log(result); // Hello, World!`].join(`
